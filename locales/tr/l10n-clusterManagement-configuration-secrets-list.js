...
module.exports = {
  ...
  SECRET_PL: 'Gizli',
  SECRET_DESC:
    'Gizli anahtar, parola, belirteç veya anahtar gibi az miktarda hassas veri içeren bir nesnedir.',
  // List
  ...
  REGISTRY_ADDRESS_TIP:
    'Bir kayıt defteri adresi ayarlayın, örneğin docker.io.',
  IMAGE_REGISTRY_REQUIRED_DESC:
    'Lütfen kayıt defteri adresini, kullanıcı adını ve parolayı ayarlayın.',
  ...
  SECRET_NO_CHINESE_CODE_DESC:
    'Gizli anahtarın anahtarı alfasayısal karakterler, kısa çizgiler (-), alt çizgiler (_) veya noktalardan (.) oluşmalıdır.',
  SECRET_TYPE_DESC: 'Bir kullanıcı tipi seçin.',
  IMAGE_REGISTRY_VALIDATE_TIP:
    'Lütfen görüntü kayıt defteri sırrını oluşturmadan önce kullanıcı adını ve parolayı doğrulayın.',
  DATA_KEY: 'Anahtar',
  DATA_VALUE: 'Değer',
  DEFAULT: 'Varsayılan',
