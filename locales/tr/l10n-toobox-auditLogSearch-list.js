...
module.exports = {
  ...
  TOTAL_AUDITING_TODAY:
    'Bugün toplam <span class={className}> {auditing} </span> denetim günlüğü girişi toplandı.',
  ...
  AUDITING_NOT_ENABLED_DESC:
    'Bileşen etkin değil. <a href="{docUrl}/pluggable-components/auditing-logs/" target="_blank">Daha Fazla Bilgi Edinin</a>',
  TIME_RANGE_LAST: 'Zaman aralığı: son {değer}',
  TIME_RANGE_RANGE: 'Zaman aralığı:{startTime} –{endTime}',
  // Querying Rules
  AUDIT_LOG_WORKSPACE_TIP:
    'Denetim günlüklerini aramak için bir çalışma alanı adı girin.',
  AUDIT_LOG_PROJECT_TIP:
    'Denetim günlüklerini aramak için bir proje adı girin.',
  AUDIT_LOG_RESOURCE_NAME_TIP:
    'Denetim günlüklerini aramak için bir kaynak adı girin.',
  AUDIT_LOG_RESOURCE_TYPE_TIP:
    'Denetim günlüklerini aramak için bir kaynak türü girin.',
  AUDIT_LOG_VERB_TIP: 'Denetim günlüklerini aramak için bir fiil girin.',
  AUDIT_LOG_STATUS_CODE_TIP:
    'Denetim günlüklerini aramak için bir durum kodu girin.',
  AUDIT_LOG_OPERATOR_TIP:
    'Denetim günlüklerini aramak için bir operatör girin.',
  AUDIT_LOG_SOURCE_IP_ADDRESS_TIP:
    'Denetim günlüklerini aramak için bir kaynak IP adresi girin.',
