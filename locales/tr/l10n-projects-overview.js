...
module.exports = {
  ...
  QUOTA: 'Kota',
  NUMBER_OF_VOLUMES: 'Hacim Sayısı',
  PROJECT_QUOTAS_NOT_SET: 'Proje Kotaları Belirlenmedi',
  PROJECT_QUOTAS_DESC:
    'Proje kotaları, kullanılabilir CPU ve bellek kaynaklarının sayısını ve projede izin verilen bölmeler, dağıtımlar ve hizmetler gibi uygulama kaynaklarının maksimum sayısını belirtir.',
  DEFAULT_CONTAINER_QUOTAS_NOT_SET: 'Varsayılan Konteyner Kotaları Ayarlanmadı',
  DEFAULT_CONTAINER_QUOTAS_DESC:
    'Varsayılan konteyner kotaları, projede oluşturulan konteynerlerin varsayılan CPU isteğini, CPU sınırını, bellek isteğini ve bellek sınırını belirtir.',
  ...
  NUMBER_OF_STATEFULSETS: 'Durum Bilgi Kümeleri Sayısı',
  NUMBER_OF_DEPLOYMENTS: 'Dağıtım Sayısı',
  // Deployed Apps
  DEPLOYED_APPS: 'Dağıtılmış Uygulamalar',
  // Resource Status
