...
module.exports = {
  ...
  ALERT_POLICY_DESC:
    'Uyarı ilkeleri, küme kaynaklarını izlemek için kullanılan bir dizi koşuldur. Kaynakları izlemek için uyarı ilkeleri oluşturabilirsiniz.',
  REQUESTS_FOR_TRIGGER_AN_ALARM_Q: 'Alarm mesajları nasıl üretilir?',
  REQUESTS_FOR_TRIGGER_AN_ALARM_A:
    'Bir kaynak için bir uyarı politikası belirlemeniz gerekir. Uyarı politikasında yapılandırılan ölçüm bir eşiğe ulaştığında uyarı mesajları oluşturulur.',
  // List
  ...
  INVALID_TIME_DESC:
    'Geçersiz değer. Lütfen açılır listeden bir değer seçin 0 veya pozitif bir tam sayı girin.',
  ALIAS: 'Takma ad',
  THRESHOLD_DURATION_MIN: 'Eşik Süresi (dk)',
  ALERT_DURATION:
    'Uyarı kuralında yapılandırılan koşulun süresi eşiğe ulaştığında uyarı ilkesinin durumu tetikleniyor olur.',
  LONG_NAME_DESC:
    'İsim yanlızda küçük harfler, sayılar ve kısa çizgiler(-) içerebilir ve küçük harf ve sayı ile başlayıp bitmelidir. Maksimum 253 karakter olabilir.',
  ...
  ALERT_RULE_EXPRESSION_DESC:
    'PromQL deyimlerini kullanarak özel bir kural tanımlayabilirsiniz. <a href="https://prometheus.io/docs/prometheus/latest/querying/basics/" target="_blank" rel="noreferrer noopener">Learn More</a>',
