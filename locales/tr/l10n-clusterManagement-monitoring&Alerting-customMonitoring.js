...
module.exports = {
  ...
  CUSTOM_MONITORING_DASHBOARD_EMPTY_DESC:
    'Lütfen özel bir izleme panosu oluşturun.',
  CUSTOM_MONITORING_DASHBOARD_DESC:
    'Özel izleme, uygulama izleme şablonları sağlar. İzleme panolarını ihtiyaçlarınıza göre özelleştirebilirsiniz.',
  // List
  // List > Create
  ...
  CUSTOM_MONITORING_TEMPLATE_DESC:
    'Özel bir izleme panosu oluşturmak için varsayılan bir şablon seçin, bir şablon yükleyin veya bir şablonu özelleştirin.',
  // List > Create > Grafana
  ...
  STACKED_GRAPH_TYPE_DESC:
    'Parçadan bütüne ilişkileri görüntülemek için kullanışlıdır',
