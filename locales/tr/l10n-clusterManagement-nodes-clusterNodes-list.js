...
module.exports = {
  ...
  CLUSTER_NODE_DESC:
    'Küme düğümleri, KubeSphere kümesinin temel sunucularıdır. Bu sayfada küme düğümlerini yönetebilirsiniz.',
  NODE_TYPES_Q: 'Küme düğümlerinin türleri nelerdir?',
  NODE_TYPES_A:
    'Düğümler, kontrol düzlemi düğümleri ve çalışan düğümleri olarak sınıflandırılır.',
  WHAT_IS_NODE_TAINTS_Q: 'Düğüm Kusurları nelerdir?',
  WHAT_IS_NODE_TAINTS_A:
    'Kusurlar, bir düğümün belirli bölmeleri püskürtmesine izin verir. Kusurlar ve toleranslar, bölmelerin uygun olmayan düğümlere programlanmamasını sağlamak için birlikte çalışır.',
