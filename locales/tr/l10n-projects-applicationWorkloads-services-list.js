...
module.exports = {
  ...
  SERVICE_TYPES_A:
    'KubeSphere durum bilgili ve durum bilgisiz servisleri destekler. Durum bilgili servislerin kapsül replikalarının her birinin bağımsız bölümleri varken, durum bilgisiz servislerin kapsül replikaları aynı bölüm içerisinde bulunurlar.',
  SCENARIOS_FOR_SERVICES_Q:
    'Durum bilgili ve durum bilgisiz servislerin kullanım senaryoları nelerdir?',
  SCENARIOS_FOR_SERVICES_A:
    'Durum bilgisiz servisler, Nginx ve Tomcat gibi veri sürerliliğinin gerekmediği senaryolarda uygulanabilir. Durum bilgili servisler ise, MySQL veritabanları, Kafka ve Zookeeper gibi veri sürerliliğinin gerektiği senaryolarda uygulanabilir.',
  // Service List
  ...
  SELECT_SERVICE_TYPE_DESC:
    'Durum bilgili veya durum bilgisiz servis oluştur, veya bir servisi harici bir servise adresle.',
  SERVICE_FROM_CODE: 'Kaynak Koddan Servis Oluştur',
  SERVICE_FROM_ARTIFACT: "Artifact'den Servis Oluştur",
  SERVICE_FROM_CODE_DESC:
    'Varolan kaynak koddan bir imaj oluştur ve imajı dağıt.',
  SERVICE_FROM_ARTIFACT_DESC:
    "Varolan bir artifact'den imah oluştur ve imajı dağıt.",
  CUSTOMIZE_SERVICE: 'Servisi Özelleştir',
  CUSTOMIZE_SERVICE_DESC:
    'İşyüklerini belirt veya bir servis oluşturmak için YAML konfigürasyon dosyasını düzenle.',
  ...
  PORT_NAME_DESC:
    'Port adı yalnızca küçük harfler, sayılar ve kısa çizgiler (-) içerebilir ve küçük harf veya sayı ile başlayıp bitmelidir. Maksimum uzunluk 63 karakterdir.',
  ...
  CREATE_EXTERNAL_SERVICE_DESC:
    'Bir servis oluştur ve onu harici bir servise adresle.',
  CREATE_EXTERNAL_SERVICE: 'Harici Servis Oluştur',
  EXTERNAL_SERVICE_ADDRESS_EMPTY_DESC:
    'Lütfen harici servisin alan adını giriniz.',
  ...
  SPECIFY_WORKLOAD_DESC:
    'Bir ya da daha fazla mevcut işyükünü kullanarak servis oluştur.',
  ...
  NO_SERVICE_RELATED_RESOURCE_DESC:
    'Servis ile ilişkili hiç bir kaynak bulunamadı.',
  DELETE_SERVICE_DESC:
    'Servis(ler)i silmek üzeresiniz {resource}. Lütfen iligli kaynağı silmek istediğinizi teyid ediniz.',
  DELETE_SERVICE_DESC_PL:
    'Servisleri silmek üzeresiniz. {resource}.<br/>Aynı zamanda, servisle ilintili aşağıdaki kaynakları da silmek istiyor musunuz?',
  DELETE_SERVICE_DESC_SI:
    'Servisi silmek üzeresiniz. {resource}.<br/>Aynı zamanda, servisle ilintili aşağıdaki kaynağı da silmek istiyor musunuz?',
