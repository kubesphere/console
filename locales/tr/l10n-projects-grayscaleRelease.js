...
module.exports = {
  ...
  BLUE_GREEN_DEPLOYMENT_DESC:
    'Hizmet trafiğini test için yeni sürüme gönderin. Yeni sürüm düzgün çalışmıyorsa, servis trafiğini hemen eski sürüme geçirebilirsiniz.',
  CANARY_RELEASE_DESC:
    'Hem yeni sürümü test etmek hem de hizmet sürekliliğini sağlamak için hizmet trafiğini yeni sürüm ve eski sürüm arasında tahsis edin.',
  TRAFFIC_MIRRORING_DESC:
    'Yeni sürümü gerçekten göstermeden test için hizmet trafiğinin bir kopyasını yeni sürüme gönderin.',
  ...
  NO_SERVICE_MESH_TIP:
    'Uygulama için uygulama yönetişimi devre dışı bırakıldı ve gri tonlamalı sürüm kullanılamaz.',
  ...
  NEW_VERSION_NUMBER_EXIST_DESC:
    '{name} iş yükü zaten var. Lütfen başka bir sürüm numarası girin.',
  ...
  NEW_VERSION_NUMBER_DESC:
    'Yeni sürüm numarası yalnızca küçük harf ve rakamlardan oluşabilir. Maksimum uzunluk 16 karakterdir.',
  NEW_VERSION_NUMBER_INVALID_DESC:
    'Geçersiz yeni sürüm numarası. Yeni sürüm numarası yalnızca küçük harf ve rakamlardan oluşabilir. Maksimum uzunluk 16 karakterdir.',
  ...
  SPECIFY_REQUEST_PARAMETERS_DESC:
    'Aşağıdaki koşulları sağlayan istekler yeni sürüme gönderilir.',
  POLICY_REQUEST_CONTENT_TIP:
    'İstek Parametrelerini Belirt işlevi yalnızca HTTP, HTTPS ve gRPG isteklerini destekler.',
  ...
  CANARY_BY_TRAFFIC_DESC:
    "<b>{component}</b> hizmetine bağlı trafiğin %{ratio}%'si, <b>{newVersion}</b> yeni sürümüne gönderilir.",
  ...
  PREREQUEST_FOR_USE_GRAYRELEASE_Q:
    'Gri tonlamalı sürümü uygulamak için ön koşullar nelerdir?',
  PREREQUEST_FOR_USE_GRAYRELEASE_A:
    'Gri tonlamalı sürümü uygulamadan önce, oluşturulmuş bir uygulama oluşturmanız ve uygulama için uygulama yönetimini etkinleştirmeniz gerekir.',
  ...
  MIRROR_POLICY_DESC:
    'Hizmet trafiğinin bir kopyası, test için yeni sürüme gönderilir. Yalnızca eski sürüm gösterilir ve yeni sürüm gösterilmez.',
  // Release Jobs > Blue-Green Deployment > Job Status
  BLUE_GREEN_TRAFFIC_DISTRI_DESC:
    'Yeni sürüm veya eski sürüm tüm trafiği alır.',
  TRAFFIC_LOW: 'trafik',
  ...
  ADJUST_TRAFFIC_DISTRIBUTION_DESC:
    "Trafiğin %{ratioNew}%'sini yeni <b>{newVersion}</b> sürümüne ve %{ratioOld}%'unu eski <b>{oldVersion}</b> sürümüne göndermek istediğinizden emin misiniz?",
  ALLOCATE_TRAFFIC_DESC:
    'Yeni sürüme gönderilen ve eski sürüme gönderilen trafiğin oranını ayarlamak için kaydırıcıyı hareket ettirin.',
  ...
  SERVICE_VERSION_RECEIVE_ALL_TRAFFIC:
    '<b>{version}</b> sürümü tüm trafiği devraldı.',
  RESTORE: 'Geri Yükle',
  ...
  DELETE_GRAYSCALE_RELEASE_JOB_DESC:
    'Lütfen gri tonlamalı yayın işini silmeden önce tüm trafiği devralacak bir sürüm seçin.',
  GRAY_COMPONENT_DESC:
    'Test edilen yeni sürüm ve eski sürüm hakkında bilgiler.',
  ...
  NEW_VERSION_TAKEOVER_DESC:
    'Yeni sürüm <b>{newVersion}</b> tüm trafiği alıyor. Mevcut gri tonlamalı yayın işini silerseniz, eski <b>{oldVersion}</b> sürümü de silinecektir.',
  OLD_VERSION_TAKEOVER_DESC:
    '<b>{oldVersion}</b> eski sürümü tüm trafiği alıyor. Mevcut gri tonlamalı yayın işini silerseniz, yeni <b>{newVersion}</b> sürümü de silinecektir.',
  GRAYSCALE_REPLICA_SI: 'Kopya: {count}',
  GRAYSCALE_REPLICA_PL: 'Kopyalar: {count}',
  TRAFFIC_MIRRORING_TRAFFIC_DISTRI_DESC:
    'Test için yeni sürüme trafiğin bir kopyası gönderilir.',
