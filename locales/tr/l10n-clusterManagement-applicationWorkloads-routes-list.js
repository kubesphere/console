...
module.exports = {
  // Banner
  ROUTE_DESC:
    'Bir router, hizmetleri toplamak için bir yol sağlar. Küme dışındaki dahili hizmetleri, dışarıdan erişilebilir bir IP adresi aracılığıyla kullanıma sunabilirsiniz.',
  PREREQUESTS_FOR_USE_ROUTE_Q:
    'Routerleri kullanmak için ön koşullar nelerdir?',
  PREREQUESTS_FOR_USE_ROUTE_A:
    'Routerleri kullanmak için, proje için ağ geçidini ayarlamak üzere proje yöneticisiyle iletişime geçmeniz gerekir.',
  ACCESS_TYPES_OF_ROUTE_Q: 'Routerlerin harici erişim modları nelerdir?',
  ACCESS_TYPES_OF_ROUTE_A:
    'KubeSphere yolları, NodePort ve LoadBalancer harici erişim modlarını destekler.',
  ROUTE_PL: 'Routerler',
  // List
  ...
  ADD_ROUTING_RULE_DESC:
    'Alan adı yollarını hizmetlere eşlemek için bir yönlendirme kuralı ekleyin.',
  ...
  NO_GATEWAY_DESC:
    "Otomatik Oluştur'u kullanmak için, projenin Ağ Geçidi Ayarlarında ağ geçidi erişim modunu ayarlamak için lütfen proje yöneticisiyle iletişime geçin.",
  PATH: 'Yol',
  PROTOCOL: 'Protokol',
