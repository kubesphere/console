...
module.exports = {
  ...
  CONTINUOUS_DEPLOYMENT_DESC:
    "GitOps'u kullanarak kaynakları sürekli olarak dağıtmak için sürekli dağıtımları yönetin. ",
  // List
  CONTINUOUS_DEPLOYMENT_EMPTY_DESC:
    'Lütfen sürekli bir dağıtım kaynağı oluşturun.',
  DEGRADED: 'Bozulmuş',
  ...
  DELETE_CONTINUOUS_DEPLOYMENT_DESC_SI:
    '{resource} sürekli dağıtımını silmek üzeresiniz. <br/>Lütfen sürekli dağıtım tarafından oluşturulan kaynakların silinip silinmeyeceğini onaylayın.',
  DELETE_CONTINUOUS_DEPLOYMENT_DESC_PL:
    '{resource} sürekli dağıtımlarını silmek üzeresiniz. <br/>Lütfen sürekli dağıtımlar tarafından oluşturulan kaynakların silinip silinmeyeceğini onaylayın.',
  NO_CONTINUOUS_DEPLOYMENT_RELATED_RESOURCE_DESC:
    'Sürekli dağıtım tarafından oluşturulan kaynak bulunamadı.',
  ...
  DELETE_CONTINUOUS_DEPLOYMENT_RELATE_DESC:
    '{resourceName} tarafından oluşturulan kaynakları silin',
  // List > Sync
  SYNC: 'Senkronizasyon',
