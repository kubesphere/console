...
module.exports = {
  ...
  LOG_COLLECTION_DESC:
    'Sistem, her bir kapsayıcıdan standart çıktı (stdout) ve standart hata (stderr) günlüklerini toplar ve bunları bir veya daha fazla hedef hizmete gönderir.',
  ...
  FLUENTD_DESC:
    'Fluentd, birleşik günlük katmanı için açık kaynaklı bir veri toplayıcıdır.',
  // Banner > Add Log Receiver > Elasticsearch
  LOG_COLLECTION_ES_URL_TIPS:
    "Yerleşik Elasticsearch hizmeti varsayılan olarak kullanılır. Küme içinde veya dışında bağımsız olarak dağıtılan Elasticsearch'ün IP adresini de girebilirsiniz.",
  LOG_COLLECTION_ES_INDEX_TIPS:
    'Sorguları hızlandırmak için dizin önekini kullanın. Dizin öneki, <Index öneki>-<Yıl-ay-tarihi> biçiminde otomatik olarak oluşturulur.',
  ...
  LOG_COLLECTION_FLUENTD_URL_TIPS:
    'Kayıtları alan Fluentd hizmetinin adresini girin.',
  // Container Logs
  LOG_COLLECTING: 'Derlemeler',
  LOG_DISABLED: 'Devre Dışı',
  EMPTY_LOG_COLLECTIONS:
    'Günlük alıcısı bulunamadı. Günlük alıcıları ekleyebilir ve günlükleri harici günlük alıcılarına gönderebilirsiniz.',
  // Resource Events
