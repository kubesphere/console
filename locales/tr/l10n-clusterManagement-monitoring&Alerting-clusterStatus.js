...
module.exports = {
  ...
  MONITORING_CLUSTER_DESC:
    'Küme durumu, küme kaynaklarının genel görünümünü ve ayrıntılarını görüntüler. Küme kaynaklarının izleme verilerini ve kullanım sıralamasını görüntüleyebilirsiniz.',
  ...
  TIMERANGE_SELECTOR_ERROR_MSG:
    'Lütfen seçilen zaman aralığının uygun olup olmadığını onaylayın!',
