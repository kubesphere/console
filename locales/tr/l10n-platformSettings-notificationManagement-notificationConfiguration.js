...
module.exports = {
  ...
  NOTIFICATION_CONFIGURATION_DESC:
    'KubeSphere, birden çok bildirim kanalı için bildirim yapılandırmasını destekler. Sunucuları ve alıcıları ayarlayabilir ve bildirimleri etkinleştirebilir veya devre dışı bırakabilirsiniz.',
  ...
  NOTIFICATION_CONDITION_SETTING_TIP:
    '<strong>Değerleri içerir</strong> ve <b>Değerleri içermez</b> işleçleri bir veya daha fazla etiket değeri gerektirir. Değerleri ayırmak için bir satır başı kullanın.</br><b>Var</b> ve <b>Varolmaz</b> işleçleri bir etiketin var olup olmadığını belirler ve bir etiket değeri gerektirmez.',
  NOTIFICATION_CONDITION_SETTINGS_DESC:
    'Yalnızca koşulları karşılayan bildirimler alacaksınız.',
  ...
  PATTERN_TAG_INVALID_TIP:
    'Geçersiz etiket. Etiket yalnızca büyük ve küçük harfler, sayılar, kısa çizgiler (-), alt çizgiler (_) ve noktalar (.) içerebilir ve bir büyük veya küçük harf veya sayı ile başlamalı ve bitmelidir.',
  PATTERN_TAG_VALUE_INVALID_TIP:
    'Geçersiz etiket değerleri. Etiket değerleri yalnızca büyük ve küçük harf, sayı, kısa çizgi (-), alt çizgi (_) ve nokta (.) içerebilir ve bir büyük veya küçük harf veya sayı ile başlayıp bitmeli ve maksimum 63 karakter olmalıdır.',
  ...
  SEND_TEST_MESSAGE_DESC:
    'Konfigürasyonlar tamamlandıktan sonra doğrulama için test mesajı gönderebilirsiniz.',
  SEND_TEST_MESSAGE_SUCCESS_DESC:
    'Başarıyla doğrulandı. Size bir test mesajı gönderildi, lütfen kontrol edin.',
  ...
  MAIL_DESC:
    'Bir sunucu ve alıcılar ayarlayarak e-posta bildirimlerini yapılandırın.',
  ...
  INVALID_EMAIL_ADDRESS_DESC:
    'E-posta biçimi yanlış. Lütfen doğru bir e-posta adresi girin.',
  ...
  PATTERN_NAME_INVALID_TIP:
    'Geçersiz isim. Ad yalnızca küçük harfler, sayılar ve kısa çizgiler (-) içerebilir.',
  // DingTalk
  DINGTALK_TITLE: 'DingTalk',
  DingTalk: 'DingTalk',
  DINGTALK_DESC:
    'Bir konuşma veya sohbet robotu ayarlayarak DingTalk bildirimlerini yapılandırın.',
  ...
  CONVERSATION_ID_TIP:
    'Konuşma kimliği ancak sistem yöneticisi tarafından yapılandırıldıktan sonra alınabilir. Görüşme kimliğini yapılandırmak için lütfen sistem yöneticisiyle iletişime geçin.',
  ...
  CONVERSATION_ID_EXISTS:
    'Görüşme kimliği zaten var. Lütfen başka bir görüşme kimliği ekleyin.',
  ...
  KEYWORD_EXISTS:
    'Anahtar kelime zaten var. Lütfen başka bir anahtar kelime ekleyin.',
  ...
  RECIPIENT_SETTINGS_TIP:
    'Bildirimleri almak için en az bir öğenin yapılandırılması gerekir.',
  ...
  WECOM_DESC:
    'Bir sunucu ve alıcılar ayarlayarak WeCom bildirimlerini yapılandırın.',
  // WeCom > User ID
  ...
  TOUSER_EXISTS:
    'Kullanıcı kimliği zaten var. Lütfen başka bir kullanıcı kimliği girin.',
  ...
  TOPARTY_EXISTS:
    'Departman kimliği zaten var. Lütfen başka bir departman kimliği girin.',
  ...
  TOTAG_EXISTS:
    'Etiket kimliği zaten var. Lütfen başka bir etiket kimliği girin.',
  ...
  SLACK_DESC:
    'Bir sunucu ve Slack kanalları ayarlayarak Slack bildirimlerini yapılandırın.',
  // Webhook
