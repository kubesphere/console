...
module.exports = {
  ...
  SERVICE_DESC:
    'Hizmetler, bir bölmede çalışan uygulamaları ağ hizmetleri olarak ortaya çıkarmak için soyut bir yol sağlar.',
  // List
  ...
  VIRTUAL_IP_DESC:
    'Hizmete sanal bir IP adresi atanır. Hizmete, küme içinde sanal IP adresi aracılığıyla erişilebilir.',
  INTERNAL_DOMAIN_NAME_DESC:
    'Hizmete sanal bir IP adresi atanır. Hizmete, küme içinde sanal IP adresi aracılığıyla erişilebilir.',
  SERVICE_PORTS_DESC:
    'Konteyner bağlantı noktalarını ve hizmet bağlantı noktalarını ayarlayın.',
  NO_WORKLOAD_MATCH_SELECTOR: 'Geçerli seçici hiçbir iş yüküyle eşleşmiyor.',
  WORKLOADS_MATCH_SELECTOR_SI:
    'Geçerli seçici ({selector}), {count} iş yüküyle eşleşiyor.',
  ...
  STICKY_SESSION_DESC:
    'Sistemi, aynı istemciden gelen tüm istekleri belirli bir süre içinde aynı bölmeye iletecek şekilde ayarlayın.',
  SERVICE_EXTERNAL_ACCESS_DESC:
    'Hizmete kümenin dışından erişme yöntemini ayarlayın.',
  ACCESS_NODEPORT_TIP:
    'Hizmete erişmek için küme düğümlerinin bir bağlantı noktasını kullanın.',
  ACCESS_LOADBALANCER_TIP: 'Hizmete erişmek için bir yük dengeleyici kullanın.',
  WORKLOAD_ANNOTATIONS: 'İş Yükü Açıklamaları',
  LABEL_FORMAT_DESC:
    'Bir etiketin anahtarı ve değeri yalnızca harf, sayı, kısa çizgi (-), alt çizgi (_) ve nokta (.) içerebilir ve bir harf veya sayı ile başlayıp bitmelidir. Her anahtarın ve her etiketin maksimum uzunluğu 63 karakterdir (anahtar bir alan adı içeriyorsa maksimum uzunluk 253 karakterdir).',
}
