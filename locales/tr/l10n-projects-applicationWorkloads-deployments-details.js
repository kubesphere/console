...
module.exports = {
  ...
  CONFIGURE_AUTOSCALING_DESC:
    'Sistemi, hedef CPU kullanımına ve hedef bellek kullanımına göre bölme kopyalarının sayısını otomatik olarak ayarlayacak şekilde ayarlayın.',
  ...
  TARGET_CPU_USAGE_DESC:
    'Gerçek CPU kullanımı hedeften daha yüksek/düşük olduğunda sistem pod replikalarının sayısını otomatik olarak azaltır/artırır.',
  TARGET_MEMORY_USAGE_DESC:
    'Gerçek bellek kullanımı hedeften daha yüksek/düşük olduğunda sistem pod replikalarının sayısını otomatik olarak azaltır/artırır.',
  MINIMUM_REPLICAS_DESC:
    "İzin verilen minimum bölme kopyası sayısını ayarlayın. Varsayılan değer 1'dir.",
  MAXIMUM_REPLICAS_DESC:
    "İzin verilen maksimum bölme kopyası sayısını ayarlayın. Varsayılan değer 1'dir.",
  ...
  REPLICAS_SCALE_NOTIFY_CONTENT:
    'Kapsül replikalarının sayısını {num} olarak değiştirmek istediğinizden emin misiniz?',
  ...
  MONITORING_ALERT_DESC:
    "Varsayılan olarak en fazla beş bölme kopyası hakkında bilgi görüntülenir. Tüm pod replikalarıyla ilgili bilgileri görüntülemek için <b>Tüm Replikaları Görüntüle</b>'yi tıklayabilirsiniz.",
