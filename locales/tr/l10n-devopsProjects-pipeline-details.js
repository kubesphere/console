...
module.exports = {
  ...
  INITIALIZING_PIPELINE_DESC:
    'Lütfen işlem hattı başlatma tamamlanana kadar bekleyin.',
  ...
  CI_DESC:
    'Sürekli entegrasyon (CI), kaynak kodu değişikliklerinden sonra otomatik olarak algılama, çekme, oluşturma ve (çoğu durumda) birim testi sürecidir.',
  CICD: 'Sürekli Entegrasyon ve Teslimat (CI/CD)',
  CICD_DESC:
    'Sürekli dağıtım (CD), yayın sürümünü sürekli teslim hattında son kullanıcılara otomatik olarak sağlama fikrini ifade eder. Kullanıcının yükleme yöntemine, bulut ortamında otomatik dağıtıma, uygulama yükseltmelerine (cep telefonlarındaki uygulamalar gibi), web sitesi güncellemelerine veya yalnızca mevcut sürümlerin listesine göre.',
  CUSTOM_PIPELIEN: 'Özel İş Hattı',
  CUSTOM_PIPELIEN_DESC:
    'İşlem hattının içeriğini özelleştirmek için ihtiyaç duyduğunuz görevleri seçebilirsiniz.',
  CC: 'CC',
  CREDENTIAL_NAME: 'Kimlik Adı',
  REMOTE_REPOSITORY_URL: "Uzak Depo URL'si",
  SCM: 'SCM',
  INPUT_MESSAGE_DESC:
    'Bu mesaj, işlem hattı çalışır durumdayken görüntülenecektir.',
...
Bu nedenle, bu adım çoğunlukla bu tür kaynakların dağıtımını işlemek için kullanılır.`,
  ...
  KUBERNETES_DEPLOY_DEPRECATED_TIP:
    'Bu adım sonraki sürümlerde kullanımdan kaldırılacaktır ve diğer alternatifleri değerlendirmeniz önerilir.',
  // Task Status > Edit Jenkinsfile
  EDIT_JENKINSFILE: 'Jenkinsdosya Düzenle',
  CLOSE_JENKINSFILE_EDITOR_TIP:
    'Jenkinsdosya düzenleyicisini kapattığınızdan emin misiniz?',
  ...
  INVALID_JENKINSFILE_TIP:
    'Geçerli Jenkinsdosyası, standart bir bildirimsel Jenkinsdosya değil ve grafiksel gösterim mevcut değil.',
  PAUSED: 'Duraklatıldı',
  // Run Records > Run
