...
module.exports = {
  ...
  DEVOPS_PROJECT_ROLES_DESC:
    'Proje rolleri, mevcut DevOps projesi kapsamında kullanıcıların sahip olduğu izinleri tanımlar.',
  // List
  ...
  PIPELINERUNS_VIEW_DESC:
    'DevOps projesinde işlem hattı çalıştırma kayıtlarını görüntüleyin.',
  PIPELINES_MANAGEMENT_DESC:
    'DevOps proje işlem hatları oluşturun, düzenleyin ve silin.',
  PIPELINES_VIEW_DESC:
    'DevOps proje işlem hatlarını görüntüleyin ve yapıtları indirin.',
  ...
  CREDENTIALS_MANAGEMENT_DESC:
    'DevOps kimlik bilgilerini oluşturun, düzenleyin ve silin.',
