...
module.exports = {
  ...
  VERSION_DESC:
    'Sürüm yalnızca küçük harfler ve sayılar içerebilir. Maksimum uzunluk 16 karakterdir.',
  APPLICATION_GOVERNANCE_DESC:
    'Uygulama için Trafik İzleme, Gri Tonlamalı Yayın ve İzleme özelliklerini kullanmak için Uygulama Yönetimini etkinleştirin.',
  APP_BASIC_INFORMATION_DESC: 'Uygulamayla ilgili temel bilgileri ayarlayın.',
  // List > Create > Service Settings
  APP_SELECT_SERVICE_TYPE_DESC:
    'Durum bilgisi olmayan veya durum bilgisi olan bir hizmet oluşturun.',
  ...
  APPLICATION_SERVICE_DESC:
    'Gereksinimlerinize göre uygulamaya durum bilgisi olan veya durum bilgisi olmayan hizmetler ekleyin.',
