...
module.exports = {
  ...
  BATCH_RUN_UNSUPPORTED_DESC:
    'Çok şubeli işlem hatları toplu olarak çalıştırılamaz.',
  // List > Edit
  // List > Copy
  COPY: 'Kopyala',
  COPY_PIPELINE: 'İş hattını Kopyala',
  PIPELINE_NAME_DESC:
    'İş hattının adı. Aynı projedeki iş hatlarından farklı adları olmalıdır.',
  ...
  PIPELINE_CREATE_DEVOPS_PROJECT_DESC:
    'İş hattının ait olduğu DevOps projesini seçin.',
  CODE_REPOSITORY_OPTIONAL: 'Kod Deposu (opsiyonel)',
  SELECT_CODE_REPO_DESC:
    'İş hattı tarafından kullanılacak bir kod deposu seçin.',
  ...
  SELECT_CREDENTIAL_DESC:
    'Kod deposuna erişmek için kullanılan bir kimlik bilgisi seçin.',
  ...
  PROJECT_GROUP_OWNER_EMPTY_TIP:
    'Lütfen GitLab proje grubunun veya proje sahibinin adını girin.',
  ...
  BITBUCKET_SERVER_EMPTY_TIP:
    'Lütfen bir Bitbucket sunucusunun adresini girin.',
  INCORRECT_USERNAME_OR_PASSWORD: 'Hatalı kullanıcı adı veya şifre.',
  BITBUCKET_SERVER_CREDENTIAL_EMPTY:
    'Lütfen bir Bitbucket sunucusu ve kimlik bilgisi ayarlayın.',
  ...
  DELETE_OUTDATED_BRANCHES_TIP:
    'Disk alanından tasarruf etmek için sistemi güncel olmayan şubeleri otomatik olarak silecek şekilde ayarlayın.',
  ...
  BRANCH_RETENTION_PERIOD_DAYS_DESC:
    "Saklama süresini aşan şubeler silinir. Varsayılan değer 7'dir.",
  MAXIMUM_BRANCHES_DESC:
    "Şube sayısı izin verilen maksimum sayıyı aştığında, en erken şube silinir. Varsayılan değer 5'tir.",
  ...
  FILTER_BY_REGEX_DESC:
    "Şubeleri PR'leri ve etiketleri filtrelemek için normal bir ifade kullanın",
  ...
  WHEN_DELETE_PIPELINE_DESC:
    'Bir işlem hattı silindiğinde, belirtilen işlem hattındaki görevler otomatik olarak tetiklenir.',
  WHEN_CREATE_PIPELINE_DESC:
    'Yeni bir işlem hattı oluşturulduğunda, belirtilen işlem hattındaki görevler otomatik olarak tetiklenir.',
  ...
  WEBHOOK_PUSH_DESC:
    "Deponun taranmasını tetiklemek için bu URL'ye bir mesaj gönderin. ",
  ...
  BUILD_RECORD_RETENTION_PERIOD_DAYS_DESC:
    "Saklama süresini aşan derleme kayıtları silinir. Varsayılan değer 7'dir.",
  MAXIMUM_BUILD_RECORDS: 'En fazla Yapı Kayıtları',
  MAXIMUM_BUILD_RECORDS_DESC:
    "Yapı kayıtlarının sayısı izin verilen maksimum sayıyı aştığında, en eski yapı kaydı silinir. Varsayılan değer 10'dur.",
  NO_CONCURRENT_BUILDS: 'Eşzamanlı derleme yok',
  NO_CONCURRENT_BUILD_DESC:
    'İşlem hattını bir seferde yalnızca bir derleme görevi çalıştıracak şekilde ayarlayın.',
  ...
  PIPELINE_PARAM_DEFAULT_DESC:
    'Parametrenin varsayılan değerini ayarlayın. İşlem hattını el ile çalıştırmadan önce değeri değiştirebilirsiniz.',
  ...
  CHOICE_PARAM_OPTION_DESC:
    'Her satıra bir seçenek girin. İlk satır varsayılan seçenek olarak kullanılır.',
  ...
  BUILD_PERIODICALLY_TIP:
    'İşlem hattını düzenli aralıklarla derleme görevlerini çalıştıracak şekilde ayarlayın.',
  PIPELINE_CRON_DESC:
    "İşlem hattı bir dahaki sefere {nextTime}'da çalıştırılacak.",
  PIPELINE_SCHEDULE_DESC:
    'Bir program ayarlamak için bir CRON ifadesi girin. <a href="//jenkins.io/doc/book/pipeline/syntax/#cron-syntax" target="_blank">Daha Fazla Bilgi Edinin</a>',
