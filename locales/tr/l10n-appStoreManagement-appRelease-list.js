...
module.exports = {
  ...
  APP_RELEASE_DESC:
    "App Store'da yayınlanacak uygulamaları yönetir. Uygulama ayrıntılarını görüntüleyebilir ve uygulama sürümlerini onaylayabilir veya reddedebilirsiniz.",
  // Unreleased
  UNRELEASED: 'Yayınlanmamış',
  APP_REVIEW_EMPTY_DESC:
    'Lütfen bir çalışma alanında bir uygulama şablonu oluşturun ve uygulama şablonunu yayınlanmak üzere gönderin.',
