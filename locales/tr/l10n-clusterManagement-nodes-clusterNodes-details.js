...
module.exports = {
  ...
  TAINTS_DESC:
    'Bölmelerin düğümlere programlanmaması veya mümkünse düğümlere programlanmaması için düğümlere kusurlar ekleyin. Düğümlere kusurlar ekledikten sonra, bölmenin belirli kusurlara sahip düğümlere programlanmasına izin vermek için bir bölmede toleranslar ayarlayabilirsiniz.',
  ...
  TAINTS_TIPS:
    '<b>Zamanlamayı engelle</b><br />Tüm bölmelerin düğüme programlanmasını engeller.<br /><br /><b>Mümkünse zamanlamayı engelle</b><br />Tüm bölmelerin mümkünse düğüme programlanıyor.<br /><br /><b>Zamanlamayı engelle ve mevcut bölmeleri çıkar</b><br />Tüm bölmelerin düğüme programlanmasını önler ve düğümdeki tüm mevcut bölmeleri çıkar.',
  ...
  NODE_MEMORYPRESSURE_DESC:
    'Düğümün kalan belleğinin eşikten az olup olmadığı.',
  NODE_DISKPRESSURE: 'Disk Baskısı',
  NODE_DISKPRESSURE_DESC:
    'Düğümün kalan disk alanı veya düğümlerinin eşikten az olup olmadığı.',
  NODE_PIDPRESSURE: 'PID Baskısı',
  NODE_PIDPRESSURE_DESC:
    'Düğümde oluşturulmasına izin verilen işlem sayısının eşikten az olup olmadığı.',
  NODE_READY: 'Hazırlık',
