...
module.exports = {
  ...
  STORAGE_CLASS_DESC:
    'Depolama sınıfları, dinamik birim sağlamayı destekleyerek yöneticilerin talep üzerine yeni depolama birimleri oluşturmasına olanak tanır.',
  // List
  ...
  PROVISIONER_DEPENDENCE_DESC:
    'Hizmet sağlamadan önce depolama sisteminize bir eklenti dağıtmanız gerekir.',
  QINGCLOUD_CSI_DESC:
    'Temel depolama eklentisi olarak QingCloud CSI kullanın. <a href="https://github.com/yunify/qingcloud-csi/blob/master/README.md#feature-matrix">Daha Fazla Bilgi Edinin</a>',
  CUSTOM: 'Özel',
  ...
  ACCESS_MODES_DESC:
    'Depolama sınıfı tarafından desteklenen bir erişim modu seçin.',
  ...
  QINGCLOUD_CSI_TYPE_DESC:
    "QingCloud Public Cloud Platform'da 0, yüksek performans hacmi anlamına gelir; 2 yüksek kapasiteli hacim; 3 ultra yüksek performans hacmi; 5 kurumsal sunucu SAN (NeonSAN); 100 standart hacim; 200 kurumsal SSD.",
  ...
  GLUSTERFS_RESTURL_DESC:
    "Hacim sağlayan Heketi REST URL'si, örneğin, <Heketi hizmet kümesi IP adresi>:<Heketi hizmeti bağlantı noktası numarası>.",
  GLUSTERFS_ID_DESC: 'Gluster küme kimliği.',
  GLUSTERFS_RESTAUTHENABLED_DESC:
    'Gluster, REST sunucusuna kimlik doğrulaması sağlar.',
  GLUSTERFS_RESTUSER_DESC:
    'Gluster REST hizmetinin veya Heketi hizmetinin kullanıcı adı.',
  ...
  GLUSTERFS_VOLUME_TYPE_DESC:
    "Hacim türü. Değer yok, replike:<Replicate count> veya disperse:<Data>:<Redundancy count> olabilir. Birim türü ayarlanmadıysa, varsayılan birim türü çoğaltma:3'tür.",
  RESTURL: 'REST URL',
  ...
  CEPHRBD_USERID_DESC:
    'RBD görüntüsünü eşlemek için kullanılan Ceph istemci kimliği. Varsayılan, adminId ile aynıdır.',
  CEPHRBD_USER_SECRET_NAME_DESC:
    'RBD görüntüsünü eşlemek için kullanıcı kimliği için Ceph gizli anahtarının adı.',
  ...
  CEPHRBD_IMAGE_FORMAT_DESC:
    'Ceph hacmi seçeneği. Değer "1" veya "2" olabilir. imageFormat\'ı "2" olarak ayarladığınızda imageFeatures\'ın doldurulması gerekir.',
  CEPHRBD_IMAGE_FEATURES_DESC:
    'Ceph kümesinin ek işlevi. Değer yalnızca imageFormat\'ı "2" olarak ayarladığınızda ayarlanmalıdır.',
