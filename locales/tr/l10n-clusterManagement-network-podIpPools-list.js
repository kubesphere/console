...
module.exports = {
  ...
  POD_IP_POOL_DESC:
    'Kapsül IP havuzları, kümedeki kapsül ağ adres alanını yönetmek için kullanılır. İhtiyaçlarınıza göre Kapsül IP havuzları oluşturabilirsiniz.',
  IPPOOL_USAGE_Q:
    'Kapsül IP havuzu kullanarak bir kapsül ağını nasıl yönetirim?',
  IPPOOL_USAGE_A:
    'Kapsül ağ adres alanını yönetmek için bir kapsül IP havuzu kullanılır ve farklı kapsül IP havuzları arasındaki adres boşlukları çakışamaz. Bir iş yükü oluştururken, bu kapsül IP havuzundan oluşturulan kapsüllere IP adresleri atamak için belirli bir kapsül IP havuzu seçebilirsiniz.',
  // List
  ...
  IP_POOL_NUM_TIP:
    'Lütfen oluşturulacak Kapsül IP havuzlarının sayısını girin.',
  IP_POOL_CREATE_COUNT_DESC:
    'Aynı anda 10 adede kadar kapsül IP havuzu oluşturulabilir.',
  ...
  IPPOOL_ASSIGN_WORKSPACE_ALLOCATED_WARNING:
    'Kapsül IP havuzu kullanımda ve başka bir çalışma alanına atanamaz.',
  IPPOOL_ASSIGN_WORKSPACE_CHANGE_WARNING:
    'Kapsül IP havuzu, atanmış belirli bir çalışma alanıyla kullanımda. Çalışma alanı değiştirilemez.',
