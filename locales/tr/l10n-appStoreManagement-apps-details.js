...
module.exports = {
  ...
  APP_SUSPEND_TIP:
    "<strong>{name}</strong> uygulaması, askıya alındıktan sonra Uygulama Mağazası'ndan dağıtılamaz. Askıya almak istediğinizden emin misiniz?",
  APP_RECOVER_TIP:
    "<strong>{name}</strong> uygulaması ve askıya alınan sürümler, Uygulama Mağazası'nda tekrar görüntülenecektir. Şimdi etkinleştirmek istediğinizden emin misiniz?",
  // Verisons > Buttons
