...
module.exports = {
  // Banner
  WORKLOAD_DESC:
    'İş yükleri, hizmet isteklerini işlemek için kullanılır ve bir veya daha fazla bölme içerebilir. Günlüğe kaydetme ve izleme gibi sistem işlevleri de iş yükleri tarafından uygulanır.',
  // List
  ...
  SPECIFY_WEIGHTS_DESC:
    'Toplam bölme çoğaltması sayısını ve her küme için bir ağırlık ayarlayın. Pod replikaları, ağırlıklara göre kümelere programlanacaktır.',
  SPECIFY_REPLICAS_DESC:
    'Her kümedeki bölme çoğaltmalarının sayısını manuel olarak ayarlayın.',
  ...
  ADD_CONTAINER_DESC:
    'Bir kapsayıcı oluşturmak için kapsayıcı ayarlarını özelleştirin.',
  CONTAINERS: 'Konteynerler',
  IMAGE_TIME_SIZE_LAYER: 'Güncelle {time}',
  IMAGE_DESC:
    'Özel bir görüntü kayıt defteri kullanmak için önce bir görüntü kayıt defteri sırrı oluşturmanız gerekir. <a href={link} target="_blank">Daha Fazla Bilgi Edinin</a>',
  ...
  TOTAL_REPLICAS_EMPTY_DESC:
    'Lütfen tüm kümelerdeki toplam kapsül kopyası sayısını girin.',
  ...
  CONTAINER_RESOURCE_LIMIT_TIP:
    'Konteynerin uygun düğümlere zamanlanması için kapsayıcının kaynak sınırlarını ve isteklerini ayarlayın.',
  GPU_TYPE: 'GPU Tipi',
  ...
  ISTIO_PROTOCOL_TIP:
    "Uygulama Yönetimi işlevini tam olarak kullanmak için hizmet tarafından kullanılan protokolü seçin. Örneğin, bir HTTP hizmeti için HTTP'yi seçin.",
  REQUIRED: 'Gerekli',
  ...
  IMAGE_PULL_POLICY_ALWAYS_DESC:
    'Bölme oluşturulduğunda veya güncellendiğinde her zaman görüntüyü çeker.',
  IMAGE_PULL_POLICY_IFNOTPRESENT_DESC:
    'Görüntüyü yalnızca yerel olarak mevcut olmadığında çeker.',
  IMAGE_PULL_POLICY_NEVER_DESC:
    'Yalnızca yerel bir görüntü kullanır. Gerekli görüntü yerel olarak mevcut değilse kapsayıcı anormal hale gelecektir.',
  ...
  READINESS_CHECK_DESC:
    'Kapsayıcının istekleri işlemeye hazır olup olmadığını kontrol eder.',
  STARTUP_CHECK_DESC:
    'Kapsayıcının başarıyla başlatılıp başlatılmadığını kontrol eder.',
  ...
  LIFECYCLE_MANAGEMENT_DESC:
    'Kapsayıcı başlatıldıktan sonra veya ortam hazırlığı veya hassas kapatma için durdurulmadan önce gerçekleştirilecek eylemleri ekleyin.',
  POSTSTART_ACTION: 'Başlangıç Sonrası Eylem',
  PRESTOP_ACTION: 'Durdurma Öncesi Eylem',
  POSTSTART_ACTION_DESC:
    'Kapsayıcı başlatıldıktan sonra gerçekleştirilecek bir eylem ekleyin.',
  PRESTOP_ACTION_DESC:
    'Kapsayıcı durdurulmadan önce gerçekleştirilecek bir eylem ekleyin.',
  ...
  CONTAINER_SECURITY_CONTEXT_DESC:
    'Kapsayıcının ayrıcalık ayarlarını özelleştirin.',
  PRIVILEGED_MODE: 'Ayrıcalıklı Mod',
  PRIVILEGED_MODE_DESC:
    'Ana bilgisayarın kök kullanıcısı olarak kapsayıcı işlemlerini çalıştırır.',
  ALLOW_PRIVILEGE_ESCALATION: 'Ayrıcalık Yükseltmesine İzin Ver',
  ALLOW_PRIVILEGE_ESCALATION_DESC:
    'Kapsayıcı işlemlerinin üst süreçten daha fazla ayrıcalık elde etmesine izin verir. Ayrıcalıklı mod etkinleştirildiğinde bu seçenek varsayılan olarak etkindir.',
  ROOT_DIRECTORY_READONLY: 'Kök Dizin Salt Okunur',
  ROOT_DIRECTORY_READONLY_DESC:
    'Kapsayıcı dosya sisteminin kök dizinini salt okunur olarak ayarlar.',
  ...
  RUN_AS_NON_ROOT_DESC:
    'Kapsayıcıyı başlatmadan önce kapsayıcının kök kullanıcı tarafından çalıştırılıp çalıştırılmayacağını kontrol eder. Evet ise, konteyner başlatılmayacaktır.',
  RUN_AS_USER_DESC:
    "Kapsayıcı işleminin giriş noktasını çalıştırmak için UID. Varsayılan değer, görüntü meta verilerinde belirtilen UID'dir.",
  RUN_AS_USER_GROUP_DESC:
    "Kapsayıcı işleminin giriş noktasını çalıştırmak için GID. Varsayılan değer, kapsayıcı çalışma zamanı varsayılan GID'sidir.",
  ...
  SYNC_HOST_TIMEZONE_DESC:
    'Kapsayıcının saat dilimini ana bilgisayarınkiyle senkronize edin.',
  ...
  ROLLINGUPDATE_DESC:
    'Yavaş yavaş eski bölme kopyalarını yenileriyle değiştirir. Güncelleme işlemi sırasında hizmet kesintiye uğramaz.',
  SIMULTANEOUS_UPDATE_DESC:
    'Yenilerini oluşturmadan önce mevcut tüm bölme kopyalarını siler. Güncelleme işlemi sırasında hizmet kesintiye uğrar.',
  ENTER_INTEGER_OR_PERCENTAGE: 'Lütfen bir tam sayı veya yüzde girin.',
  MAX_EXTRA_EMPTY:
    'Lütfen güncelleme işlemi sırasında izin verilen fazladan pod replikalarının maksimum sayısını veya yüzdesini ayarlayın.',
  ...
  POD_SECURITY_CONTEXT_TIP:
    'Kullanıcı, Kullanıcı Grubu ve SELinux Bağlamı ayarları hem pod Güvenlik Bağlamı hem de Kapsayıcı Güvenlik Bağlamı içinde tanımlanmışsa, Kapsayıcı Güvenlik Bağlamı ayarları, Kapsül Güvenlik Bağlamı ayarlarını geçersiz kılar.',
  // List > Create > Pod Settings > Pod Scheduling Rules
  POD_SCHEDULING_RULES: 'Kapsül Zamanlama Yöntemi',
  POD_SCHEDULING_RULES_DESC:
    'Bölme çoğaltmalarını düğümlere zamanlamak için kuralları belirtin.',
  DEFAULT_RULES: 'Varsayılan kurallar',
  DEFAULT_RULES_DESC:
    'Pod replikalarını varsayılan kurallara göre düğümlere zamanlar.',
  DECENTRALIZED_SCHEDULING: 'Merkezi Olmayan Zamanlama',
  CUSTOM_RULES: 'Özel Kurallar',
  CUSTOM_RULES_DESC:
    'Özel kurallara göre düğümlere bölme çoğaltmalarını zamanlar.',
  'Pod IP': 'Pod Ip Adresi',
  DECENTRALIZED_SCHEDULING_DESC:
    'Mümkünse, bölme çoğaltmalarını farklı düğümlere zamanlar.',
  CENTRALIZED_SCHEDULING_DESC:
    'Mümkünse bölme çoğaltmalarını aynı düğüme programlar.',
  ...
  WORKLOAD_MOUNT_VOLUME_DESC:
    'Mevcut bir birimi, geçici birimi veya HostPath birimini kapsayıcılara bağlayın.',
  ...
  HOSTPATH_TIP:
    'Ana bilgisayar dosya sistemindeki bir dosyayı veya dizini kapsayıcılara bağlamak için bir HostPath birimi kullanın.',
  ...
  MOUNT_CONFIGMAP_OR_SECRET_DESC:
    'Konteynerlara bir yapılandırma haritası veya gizli anahtar ekleyin.',
  ...
  READ_WRITE_MOUNT_EMPTY:
    'Lütfen birim erişim modunu ve bağlama yolunu belirtin.',
  SELECT_SPECIFIC_KEYS: 'Belirli Anahtarları Seçin',
  SELECT_SPECIFIC_KEYS_DESC:
    'Konteynerlere monte edilecek belirli anahtarları seçin.',
  ...
  SELECT_NODES_DESC:
    'Belirli düğümlere bölme çoğaltmaları atayın. Düğümleri seçmek veya manuel olarak bir düğüm belirtmek için etiketleri kullanabilirsiniz.',
  ...
  CLUSTER_DIFF_CONTAINER_SETTINGS_DESC:
    'Farklı kümelerde farklı kapsayıcı ayarları kullanın.',
  CLUSTER_DIFF_PORT_SETTINGS_DESC:
    'Farklı kümelerdeki kapsayıcılar için farklı bağlantı noktaları ayarlayın.',
  CLUSTER_DIFF_ENVIRONMENT_VARIABLES_DESC:
    'Farklı kümelerdeki kapsayıcılar için farklı ortam değişkenleri ayarlayın.',
}
