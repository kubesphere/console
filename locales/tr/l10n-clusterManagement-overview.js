...
module.exports = {
  ...
  CLUSTER_BASE_INFO_DESC:
    'Temel bilgiler, kümeye genel bir bakış sağlar. Küme bilgilerini görüntüleyebilir ve düzenleyebilirsiniz.',
  // System Components
  // Resource Usage
  MEMORY: 'Bellek',
  TOTAL: 'Toplam',
  ...
  // Tools
  KUBECTL_DESC:
    'Geçerli kümeyi kontrol etmek için kullanılan komut satırı aracı.',
  KUBECONFIG_DESC:
    'Geçerli kümeyle ilgili erişim bilgilerini yapılandırmak için kullanılan dosya.',
  // Kubernetes Status
