...
module.exports = {
  ...
  ROLE_PROJECT_REGULAR:
    'Projedeki kullanıcılar ve roller dışındaki kaynakları yönetin.',
  ...
  APPLICATION_WORKLOADS_VIEW_DESC:
    'Projedeki uygulamalar, hizmetler, iş yükleri, işler, gri tonlamalı yayın işleri ve görüntü oluşturucular gibi kaynakları görüntüleyin.',
  APPLICATION_WORKLOADS_MANAGEMENT_DESC:
    'Projede uygulamalar, hizmetler, iş yükleri, işler, gri tonlamalı yayın işleri ve görüntü oluşturucular gibi kaynakları oluşturun, düzenleyin ve silin.',
  ...
  VOLUME_SNAPSHOTS_VIEW_DESC:
    'Projedeki birim anlık görüntülerini görüntüleyin.',
  VOLUME_SNAPSHOTS_MANAGEMENT_DESC:
    'Projede birim anlık görüntülerini oluşturun, düzenleyin ve silin.',
  ...
  CONFIGMAPS_MANAGEMENT_DESC:
    'Projede yapılandırma haritaları oluşturun, düzenleyin ve silin.',
  SERVICEACCOUNT_MANAGEMENT_DESC:
    'Projede hizmet hesapları oluşturun, düzenleyin ve silin.',
  ...
  PROJECT_ROLES_MANAGEMENT_DESC:
    'Önceden ayarlanmış roller dışında proje rolleri oluşturun, düzenleyin ve silin.',
  PROJECT_MEMBERS_VIEW_DESC: 'Proje üyelerini görüntüleyin.',
  PROJECT_MEMBERS_MANAGEMENT_DESC:
    'Proje üyelerini davet edin, düzenleyin ve kaldırın.',
  // List > Edit Permissions > Project Settings
  PROJECT_SETTINGS_DESC:
    'Proje temel bilgileri, harici erişim ayarları, ağ ilkeleri, kaynak kotaları ve günlük toplama ayarları dahil proje ayarlarını yönetin.',
  // List > Delete
  DELETE_ROLE: 'Rolü Sil',
  DELETE_ROLE_TIP:
    '<strong>{resource}</strong> rolünü silmek istediğinizden emin misiniz?',
  DELETE_ROLE_USER_TIP_PL:
    'Rol, <strong>{count}</strong> kullanıcı için yetkilendirilmiştir. Lütfen önce kullanıcıları silin veya kullanıcının rollerini değiştirin.',
  DELETE_ROLE_USER_TIP:
    'Rol, <strong>{count}</strong> kullanıcısına yetkilendirilmiştir. Lütfen önce kullanıcıyı silin veya kullanıcının rolünü değiştirin.',
  DELETE_ROLE_DEPARTMENT_TIP_PL:
    'Rol, <strong>{count}</strong> departman için yetkilendirilmiştir. Lütfen önce departmanları silin veya departmanların rollerini değiştirin.',
  DELETE_ROLE_DEPARTMENT_TIP:
    'Rol, <strong>{count}</strong> departmanı için yetkilendirilmiştir. Lütfen önce departmanı silin veya departmanın rolünü değiştirin.',
}
