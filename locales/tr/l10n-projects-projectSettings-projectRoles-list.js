...
module.exports = {
  ...
  PERMISSION_ALERTING_MESSAGES_VIEW: 'Uyarı Mesajı Görüntüleme',
  PERMISSION_ALERTING_MESSAGES_VIEW_DESC: 'Projedeki uyarı mesajlarını görüntüleyin.',
  PERMISSION_ALERTING_MESSAGES_MANAGEMENT: 'Uyarı Mesajları Yönetimi',
  PERMISSION_ALERTING_MESSAGES_MANAGEMENT_DESC: 'Projedeki uyarı mesajlarına yorum yapın ve bunları silin.',
  PERMISSION_ALERTING_POLICIES_VIEW: 'Uyarı Politikası Görüntüleme',
  PERMISSION_ALERTING_POLICIES_VIEW_DESC: 'Projedeki uyarı politikalarını görüntüleyin.',
  PERMISSION_ALERTING_POLICIES_MANAGEMENT: 'Uyarı Politikası Yönetimi',
  PERMISSION_ALERTING_POLICIES_MANAGEMENT_DESC: 'Projede uyarı ilkeleri oluşturun, düzenleyin ve silin.',
