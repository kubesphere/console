...
module.exports = {
  ...
  // List > Create
  CREATE_PLATFORM_ROLE: 'Plattformrolle erstellen',
  // List > Create > Edit Permissions > Cluster Management
  PERMIGROUP_CLUSTERS_MANAGEMENT: 'Cluster',
  PERMISSION_CLUSTERS_VIEW: 'Cluster anzeigen',
  PERMISSION_CLUSTERS_VIEW_DESC: 'Alle Cluster und Cluster-Ressourcen anzeigen.',
  PERMISSION_CLUSTERS_MANAGEMENT: 'Cluster verwalten',
  ...
  PERMISSION_WORKSPACES_VIEW: 'Arbeitsbereich anzeigen',
  PERMISSION_WORKSPACES_VIEW_DESC: 'Arbeitsbereiche anzeigen.',
  PERMISSION_WORKSPACES_MANAGEMENT: 'Arbeitsplatzverwaltung',
  ...
  PERMISSION_USERS_VIEW: 'Benutzer anzeigen',
  PERMISSION_USERS_VIEW_DESC: 'Benutzer anzeigen.',
  PERMISSION_USERS_MANAGEMENT: 'Benutzer verwalten',
  PERMISSION_USERS_MANAGEMENT_DESC: 'Benutzer erstellen, bearbeiten und löschen.',
  PERMISSION_ROLES_VIEW: 'Rollen anzeigen',
  PERMISSION_ROLES_VIEW_DESC: 'Plattformrollen anzeigen.',
  PERMISSION_ROLES_MANAGEMENT: 'Rollen verwalten',
  PERMISSION_ROLES_MANAGEMENT_DESC: 'Plattformrollen erstellen, bearbeiten und löschen.',
  // List > Create > Edit Permissions > Apps
  PERMIGROUP_APPS_MANAGEMENT: 'Apps',
  PERMISSION_APP_TEMPLATES_VIEW: 'Apps anzeigen',
  PERMISSION_APP_TEMPLATES_VIEW_DESC: 'Plattform App Store ansehen.',
