...
module.exports = {
  ...
  UNKNOWN: 'Unbekannt',
  EXTERNAL_ACCESS: 'Externer Zugang',
  INTERNAL_ACCESS: 'Interner Zugang',
  // List > Edit YAML
  // List > Edit Service
  UNKNOWN_SERVICE_TYPE: 'Unbekannter Servicetyp',
  // List > Delete
  SERVICE: 'Dienst',
  SERVICE_LOW: 'dienst',
  // List > Create
  ...
  ENTER_SELECTOR_TIP: 'Bitte legen Sie einen Workload-Selektor fest.',
  Ports: 'Ports',
  SPECIFY_WORKLOAD: 'Workload angeben',
  SELECT_WORKLOAD_DESC: 'Verwenden Sie Labels einer Workload als Selektor.',
  ...
  NO_WORKLOAD_MATCH_SELECTOR: 'Der aktuelle Selektor entspricht keiner Workload.',
  WORKLOADS_MATCH_SELECTOR_SI: 'Der aktuelle Selektor ({selector}) stimmt mit {count} Workload überein.',
  WORKLOADS_MATCH_SELECTOR_PL: 'Der aktuelle Selektor ({selector}) stimmt mit {count} Workloads überein.',
  WORKLOAD_SELECTOR: 'Workload-Selektor',
  SERVICE_SETTINGS: 'Diensteinstellungen',
  // List > Create > Service Settings > Workload Selector > View Details
  TOTAL_WORKLOADS_VALUE: 'Insgesamte Workloads: {count}',
  ...
  WORKLOAD_ANNOTATIONS: 'Workload-Anmerkungen',
