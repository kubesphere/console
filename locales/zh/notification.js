...
module.exports = {
  ...
  MAIL_DESC: 'You can receive email notifications from the platform after configuring the outgoing mail server.',
  ...
  DINGTALK_DESC: 'You can receive DingTalk notifications from the platform after configuring the DingTalk server.',
  ...
  'Please enter the WeChat API Agent ID': 'Please enter the WeChat API Agent ID',
  ...
  WECOM_DESC: 'You can receive WeCom notifications from the platform after configuring the WeCom server.',
  ...
  SLACK_DESC: 'You can receive Slack notifications from the platform after configuring the Slack server.',
