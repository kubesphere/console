...
module.exports = {
  ...
  CLUSTER_CONSUMPTION_DESC: '集群资源消费情况以集群为维度统计集群，节点的CPU、内存、存储等资源消费情况',
  CLUSTER_RESOURCE_CONSUMPTION_DESC: '<strong>集群</strong> 的CPU、内存、存储等资源消费情况',
  CLUSTER_NODE_CONSUMPTION_DESC: '集群中 <strong>节点</strong> 的CPU、内存、存储等资源消费情况',
  'Workspace Consumption': '企业空间（项目）资源消费情况',
  CLUSTER_POD_CONSUMPTION_DESC: '节点中 <strong>容器组</strong> 的CPU、内存等资源消费情况',
  WORKSPACE_CONSUMPTION_DESC: '企业空间(项目)资源消费情况以企业空间为维度统计企业空间和项目的CPU、内存、存储等资源消费情况',
  WORKSPACE_RESOURCE_CONSUMPTION_DESC: '<strong>企业空间</strong> 的CPU、内存、存储等资源消费情况',
  WORKSPACE_PROJECT_CONSUMPTION_DESC: '企业空间中的 <strong>项目</strong> 的CPU、内存、存储等资源消费情况',
  PROJECT_CONSUMPTION_DESC: '项目中的<strong>应用、服务、容器组</strong>等资源 的CPU、内存、存储等资源消费情况',
  ...
  'Total Consumer Desc': '共消费表示在当前对账周期中每个计费采样点的资源用量之和',
  TIMERANGE_MORE_30DAY_MSG: '结束时间与开始时间的间隔大于30天时，时间间隔最小为1天',
  TOTAL_COST: '总金额({unit})',
  '￥': '￥',
  Price: '价格',
