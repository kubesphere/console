...
module.exports = {
  ...
  CLUSTER_RESOURCE_CONSUMPTION_DESC: 'Resource consumption of the <strong>cluster</strong>, including CPU, memory and storage.',
  CLUSTER_NODE_CONSUMPTION_DESC: 'Resource consumption of <strong>nodes</strong>, including CPU, memory, and storage.',
  ...
  WORKSPACE_CONSUMPTION_DESC: 'View metering and billing information of workspace resources.',
  WORKSPACE_RESOURCE_CONSUMPTION_DESC: 'Resource consumption of <strong>workspaces</strong>, including CPU, memory, and storage.',
  WORKSPACE_PROJECT_CONSUMPTION_DESC: 'Resource consumption of workspace <strong>projects</strong>, including CPU, memory, and storage.',
  PROJECT_CONSUMPTION_DESC: 'Resource consumption of <strong>apps, Services and Pods</strong> in projects, including CPU, memory, and storage.',
  ...
  'Total Consumer Desc': 'It refers to the total consumption of a resource type within the current billing cycle.',
