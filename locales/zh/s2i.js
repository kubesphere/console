...
module.exports = {
  ...
  'The logging module is not installed.': 'The logging module is not installed.',
  'Log is loading...': 'Log is loading...',
  'New Image Tag': 'New Image Tag',
  'New Tag': 'New Tag',
  'No Log Records': 'No Log Records',
  'Please set the access policy for the container.': 'Please set the access policy for the container.',
  'Please set the container name and computing resources.': 'Please set the container name and computing resources.',
  ...
  sourceUrl: 'sourceUrl',
  SourceUrl: 'SourceUrl',
  'Specify a relative directory inside the application. (Default value /)': 'Specify a relative directory inside the application. (Default value /)',
  'Start Command': 'Start Command',
  StartTime: 'StartTime',
  'Target Image Repository': 'Target Image Repository',
  'The current code repository does not require a key.': 'The current code repository does not require a key.',
  'The file has not been uploaded.': 'The file has not been uploaded.',
  'The health of the container will be checked regularly according to user needs.': 'The health of the container will be checked regularly according to user needs.',
  ...
  START_COMMAND_DESC: 'By default, the container runs the default image command. You can change the container command from here.',
  RUN_COMMAND_DESC: 'The start command of the container. By default, the start command for packaging will be used. Please use commas to separate multiple commands.',
  CONTAINER_PARAMS_DESC: 'The start command parameters of the container. Please use commas to separate multiple ones.',
  ...
  S2I_ENVIROMENT_DESC: 'App developers can use the following environment variables to configure the runtime behavior of the image. For more information, see <a href={link} target="_blank">S2I Templates</a>.',
  ...
  S2I_SECRET_DESC: 'If it is a private code repository, choose the code repository key.',
  ...
  S2I_TARGET_IMAGE_REPONSTRY_DESC: 'You need to select an image repository with push permissions to store the image. If it is not available, you need to <a href={link} target="_blank">create a new image repository Secret</a>.',
  ...
  JAR_DESC: 'A JAR file is a package file format that is commonly used to aggregate a large number of Java class files, related metadata and resources (text, images, etc.) files into a file.',
  WAR_DESC: 'WAR file is a file used to distribute a collection of JAR-files, JavaServer Pages, Java Servlets, Java classes, XML files, tag libraries, static web pages (HTML and related files) and other resources that together constitute a web application.',
  BINARY_DESC: '',
  IMAGE_BUILDER_CREATE_DESC: 'Image Builder is a tool that makes it easy to write container images that take application source code or artifacts as an input and produce a new image that runs the assembled application as output. It includes Source to Image, a.k.a S2I which takes source code as input, and Binary to Image, a.k.a. B2I which takes application artifacts as input.',
  ...
  SECRET_CODE_RULE_DESC: 'It can only contain upper and lower case letters, numbers.',
