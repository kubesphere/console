...
module.exports = {
  ...
  WORKSPACE_OVERVIEW_DESC: '企业空间为 KubeSphere 提供了安全隔离的、具有访问权限控制的工作平台。这里您可以看到当前企业空间内资源运行的概况。',
  WORKSPACE_DESC: '企业空间是一个组织您的项目和 DevOps 工程、管理资源访问权限以及在团队内部共享资源等的逻辑单元，可以作为团队工作的独立工作空间。',
  WORKSPACE_SEARCH_PLACEHOLDER: '请输入企业空间名称进行查找',
  WORKSPACE_CREATE_DESC: '企业空间是一个组织您的项目和 DevOps 工程、管理资源访问权限以及在团队内部共享资源等的逻辑单元，可以作为团队工作的独立工作空间。',
  WORKSPACE_NAME_DESC: '请尽量保持名称简短，比如用企业名称的缩写或者大家经常的称呼，无需使用企业的完整名称或者营业执照上的注册名称。',
  WORKSPACE_LOGO_PLACEHOLDER: '企业标志尺寸必须小于 200px X 200px，支持 png，jpg 格式。建议从上传透明背景的 PNG 格式图片以达到最佳展示效果。',
  NO_WORKSPACE_TIP: '您的帐户目前不属于任何企业空间，请您创建一个企业空间或者联系管理员邀请您到其企业空间内进行工作',
  WORKSPACE_MEMBER_DESC: '对企业空间内的成员进行管理及角色分配。项目可以邀请当前企业空间内的企业成员作为项目成员，协同工作。',
  ...
  NO_PUBLIC_CLUSTER_TIP: '暂无可用的公开集群, 请在企业空间创建完毕后, 向平台管理员或集群管理员申请集群的授权',
  WORKSPACE_NO_CLUSTER_TIP: '您需要联系平台管理员或者集群管理员为企业空间授权集群的访问权限',
  WORKSPACE_BASE_INFO_Q1: '如何为企业空间申请更多的集群？',
  WORKSPACE_BASE_INFO_A1: '集群由平台管理员以及集群管理员共同运营维护，如果您需要使用更多的集群请联系您的平台管理员，或者提交申请',
  ...
  HOW_TO_APPLY_MORE_CLUSTER_A: '集群由平台管理员以及集群管理员共同运营维护，如果您需要使用更多的集群请联系您的平台管理员，或者提交申请',
  ...
  WORKSPACE_GROUP_DESC: '组织可以以用户组或者部门的形式授予项目以及 Devops 工程权限',
  WORKSPACE_GROUP_EMPTY_DESC: '暂时没有可用的组织机构，请先维护组织机构后添加成员',
  WORKSPACE_GROUP_USER_EMPTY_DESC: '暂时没有可分配的成员',
  WORKSPACE_QUOTA_MANAGE_DESC: '管理企业空间配额，企业空间下的所有项目 / DevOps 工程将共享这些配额',
