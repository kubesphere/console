...
module.exports = {
  ...
  WORKSPACE_CREATE_DESC: 'A workspace is an isolated logical unit used to organize projects and DevOps projects, manage resource access, and share information within your team.',
  ...
  WORKSPACE_MEMBER_DESC: 'Manage workspace members and their roles. Workspace members can be invited to projects in the workspace.',
  ...
  NO_PUBLIC_CLUSTER_TIP: 'No public cluster available. Please contact the platform or cluster administrator to obtain authorization.',
  WORKSPACE_NO_CLUSTER_TIP: 'No cluster available. Please contact the platform or cluster administrator to obtain authorization.',
  ...
  WORKSPACE_GROUP_DESC: 'Create departments in your workspace and assign users to different departments to implement permission control.',
  WORKSPACE_GROUP_EMPTY_DESC: 'No Department Available',
  WORKSPACE_GROUP_USER_EMPTY_DESC: 'No user available.',
  WORKSPACE_QUOTA_MANAGE_DESC: 'Manage workspace quotas, which are shared by all projects and DevOps projects in the workspace.',
