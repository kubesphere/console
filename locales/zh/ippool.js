...
module.exports = {
  ...
  'Please input the number of Pod IP Pools to be created': '请输入需要创建的容器组 IP 池数量',
  ...
  IPPOOL_ASSIGN_WORKSPACE_ALLOCATED_WARNING: 'IP 池已被使用，无法分配给某一个具体的企业空间',
  IPPOOL_ASSIGN_WORKSPACE_CHANGE_WARNING: 'IP 池已被使用，且已指定具体的企业空间，无法更改目标企业空间',
