...
module.exports = {
  ...
  'Alternate options, one per line. The first line will be used as the default option.': 'Alternate options, one per line. The first line will be used as the default option.',
  'Any repository containing Jenkinsfile will be built automatically.': 'Any repository containing Jenkinsfile will be built automatically.',
  archiveArtifacts: 'archiveArtifacts',
  'Are you sure to close this pipeline Editor ?': 'Are you sure to close this pipeline Editor ?',
  'Are you sure to close this jenkinsfile Editor ?': 'Are you sure to close this jenkinsfile Editor ?',
  artifacts: 'artifacts',
  Artifacts: 'Artifacts',
  ...
  'Exclude branches that are also filed as PRs': 'Exclude branches that are also filed as PRs',
  ...
  'From users with Admin or Write permission': 'From users with Admin or Write permission',
  'get token': 'get token',
  'Git Clone Options': 'Git Clone Options',
  'If not, scan regularly': 'If not, scan regularly',
  'If you check this option, you cannot run multiple builds concurrently.': 'If you check this option, you cannot run multiple builds concurrently.',
  info: 'info',
  input: 'input',
  ...
  Issues: 'Issues',
  'It specifies the default value of the field, allowing the user to save the typed actual value.': 'It specifies the default value of the field, allowing the user to save the typed actual value.',
  ...
  'Old builds will be deleted after this number of days.': 'Old builds will be deleted after this number of days.',
  'Old builds will be discarded after the build number exceeds the maximum amount.': 'Old builds will be discarded after the build number exceeds the maximum amount.',
  'Only branches that are also filed as PRs': 'Only branches that are also filed as PRs',
  ...
  'Please select a code repository as the code source for the pipeline.': 'Please select a code repository as the code source for the pipeline.',
  ...
  'Specify the location of the Jenkinsfile in the source code repository': 'Specify the location of the Jenkinsfile in the source code repository',
  'Start the follow-up task after the inspection': 'Start the follow-up task after the inspection',
  'Started By': 'Started By',
  'Stop Job Successfully, Status updated later': 'Stop Job Successfully, Status updated later',
  ...
  'The default value here is the current user\'s kubeconfig.': 'The default value here is the current user\'s kubeconfig.',
  ...
  'The name of the pipeline. Pipelines in the same project must have different names.': 'The name of the pipeline. Pipelines in the same project must have different names.',
  ...
  'Trigger a remote build (for example, using a script)': 'Trigger a remote build (for example, using a script)',
  ...
  tips_Timing_build: 'Provides cron-like functionality to perform this project regularly',
  ...
  WEBHOOK_DESC: 'Push a message to this URL to trigger a reindexing of the repository. ',
  ...
  PIPELINE_PREPAIR_DESC: 'The environment is being prepared. There will be a graphical display later.',
  ...
  EDIT_CREDENTIAL_DESC: 'The following form will not display the original credential information. Re-entering it will overwrite it.',
  ...
  REG_FILTER_DESC: 'Enable regular expressions, ignoring names that do not match the provided regular expression (including branches and PRs)',
  ...
  bitbucket_server_ACCESSTOKEN_PLACEHOLDER: 'Please input your Bitbucket account information.',
