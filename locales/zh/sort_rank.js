...
module.exports = {
  ...
  SORT_BY_NAMESPACE_POD_COUNT: '按容器组用量排行',
  SORT_BY_NAMESPACE_NET_BYTES_RECEIVED: '按网络流入速率排行',
  SORT_BY_NAMESPACE_NET_BYTES_TRANSMITTED: '按网络流出速率排行',
  SORT_BY_WORKSPACE_MEMORY_USAGE: '按内存用量排行',
  SORT_BY_WORKSPACE_MEMORY_USAGE_WO_CACHE: '按内存用量排行',
  SORT_BY_WORKSPACE_POD_COUNT: '按容器组用量排行',
  SORT_BY_WORKSPACE_CPU_USAGE: '按 CPU 用量排行',
  SORT_BY_WORKSPACE_NET_BYTES_TRANSMITTED: '按网络流出速率排行',
  SORT_BY_WORKSPACE_NET_BYTES_RECEIVED: '按网络流入速率排行',
  SORT_BY_WORKLOAD_CPU_USAGE: '按 CPU 用量排行',
  SORT_BY_WORKLOAD_MEMORY_USAGE_WO_CACHE: '按内存用量排行',
  SORT_BY_WORKLOAD_NET_BYTES_TRANSMITTED: '按网络流出速率排行',
  SORT_BY_WORKLOAD_NET_BYTES_RECEIVED: '按网络流入速率排行',
}
