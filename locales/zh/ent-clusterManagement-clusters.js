...
module.exports = {
  ...
  REMOVE_CLUSTER_TIP_C: '请参考 KubeSphere 官方文档清除集群中的配置信息，以避免当前集群加入其他多集群系统时出现资源冲突。',
  // Cluster Tags
  CLUSTER_TAGS: '集群标签',
  ...
  DELETE_CLUSTER_TAG_CONFIRM_DESC: '请输入标签的键和值 <strong>{resource}</strong> 以确认您了解此操作的风险。',
  DELETE_CLUSTER_TAGS_CONFIRM_DESC: '请输入标签的键和值 <strong>{resource}</strong> 以确认您了解此操作的风险。',
  // Cluster Tags > Edit
  EDIT_TAG: '编辑标签',
