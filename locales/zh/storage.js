...
module.exports = {
  ...
  GLUSTERFS_SECRET_NAMESPACE_DESC: 'Heketi 用户 Secret 的所属项目。',
  GLUSTERFS_SECRET_NAME_DESC: 'Heketi 用户 Secret 的名称。',
  ...
  CEPHRBD_ADMIN_SECRET_NAME_DESC: 'adminid 的 Secret 名称。',
  CEPHRBD_ADMIN_SECRET_NAMESPACE_DESC: 'adminSecret 所在的项目。',
  CEPHRBD_POOL_DESC: 'Ceph RBD 的 Pool 名称。',
  CEPHRBD_USERID_DESC: 'Ceph 集群能够挂载卷的用户 ID。',
  CEPHRBD_USER_SECRET_NAME_DESC: 'userid 的 Secret 名称。',
