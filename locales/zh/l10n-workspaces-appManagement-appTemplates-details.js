...
module.exports = {
  ...
  VERSION_SUSPEND_TIP: '版本 <strong>{name}</strong> 取消发布后，关联的应用将不显示该版本，您确定要取消发布吗？',
  VERSION_RECOVER_TIP: '版本 <strong>{name}</strong> 恢复发布后，关联的应用将显示出该版本，您确定要恢复发布吗？',
