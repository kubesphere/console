...
module.exports = {
  ...
  ENABLE_GATEWAY_DESC: '在创建应用路由之前，需要先开启外网访问入口，即网关。这一步是创建对应的应用路由控制器，负责将请求转发到对应的后端服务。',
  ...
  CLUSTER_GATEWAY_GUIDE_DESC: '如果同时存在集群网关和项目网关，项目网关关闭后无法再次开启。建议仅使用集群网关或仅使用项目网关。'
};