...
module.exports = {
  ...
  ROLE_USERS_TIP: '当前角色有 <strong>{count}</strong> 名授权用户，请先移除授权用户或更改角色后再删除。',
  ROLE_USER_TIP: '当前角色有 <strong>{count}</strong> 名授权用户，请先移除授权用户或更改角色后再删除。',
  ROLE_USER_GROUPS_TIP: '当前角色已被分配给 <strong>{count}</strong> 个部门，请先移除授权部门或更改角色后再删除。',
  ...
  CLUSTER_SETTINGS_DESC: '管理集群设置，编辑集群信息，集群对企业空间的授权管理等',
  WORKSPACE_ROLE_NAME_TIP: '请设置一个唯一标识符作为角色名称。',
  ROLE_CREATE_TIP_TITLE: '接下来要做的事情',
  ROLE_CREATE_TIP_MESSAGE: '接下来您需要编辑权限，编辑好权限后帐户角色才能创建成功。',
  ...
  WORKSPACES_MANAGEMENT_DESC: '支持企业空间的管理，包括添加/删除/编辑企业空间，查看平台的所有企业空间。',
  ...
  APP_TEMPLATES_MANAGEMENT_DESC: '管理平台级别的应用商店，对云原生应用的上架、下架以及审核等应用全生命周期的统一管理。',
  ...
  PIPELINES_MANAGEMENT_DESC: '管理 DevOps 工程流水线，包含 创建/编辑/删除 等操作.',
  PIPELINES_VIEW_DESC: '查看 DevOps 工程流水线，下载制品等.',
  CREDENTIALS_MANAGEMENT_DESC: '管理 DevOps 工程凭证，包含 创建/编辑/删除 等操作.',
  CREDENTIALS_VIEW_DESC: '查看与使用凭证',
  DEVOPS_ROLES_VIEW_DESC: '查看 DevOps 工程角色',
  DEVOPS_ROLES_MANAGEMENT_DESC: '可以 创建/编辑/删除  DevOps 工程角色，系统预置角色无法删除',
  ...
  APPLICATION_WORKLOADS_VIEW_DESC: '查看项目里的应用、服务、工作负载、任务、灰度发布和镜像构建器等资源',
  APPLICATION_WORKLOADS_MANAGEMENT_DESC: '创建/编辑/删除/项目里的应用、服务、工作负载、任务、灰度发布和镜像构建器等资源',
  ...
  PROJECT_ROLES_MANAGEMENT_DESC: '可以 创建/编辑/删除 项目角色，系统预置角色无法删除',
  PROJECT_MEMBERS_VIEW_DESC: '查看项目成员',
  PROJECT_MEMBERS_MANAGEMENT_DESC: '邀请/编辑/移除项目成员',
  PROJECT_SETTINGS_DESC: '管理项目设置，编辑项目信息、外网访问、网络策略、资源配额、落盘日志收集配置等',
  ...
  DEVOPS_MANAGEMENT_DESC: '管理企业空间里的所有 DevOps 工程，可以 创建/编辑/删除 DevOps 工程',
  DEVOPS_CREATE_DESC: '拥有创建 DevOps 工程的权限，DevOps 工程管理员只能为创建者自己',
  DEVOPS_VIEW_DESC: '可以查看企业空间里的所有 DevOps 工程',
  WORKSPACE_GROUPS_VIEW_DESC: '查看企业组织架构及成员',
  WORKSPACE_GROUPS_MANAGEMENT_DESC: '管理企业组织架构，邀请/移除组织成员，为组织授权',
  WORKSPACE_ROLES_VIEW_DESC: '查看企业空间角色',
  WORKSPACE_ROLES_MANAGEMENT_DESC: '可以 创建/编辑/删除 企业空间角色，系统预置角色无法删除',
  ...
  WORKSPACE_APP_TEMPLATES_MANAGEMENT_DESC: '上传/编辑/删除 企业空间应用模板，上架/下架应用到平台的应用商店',
  ...
  WORKSPACE_SETTINGS_MANAGEMENT_DESC: '管理企业空间设置，编辑企业空间信息、网络策略等',
  ROLE_PLATFORM_ADMIN: '平台管理员，可以管理平台内的所有资源。',
  ROLE_PLATFORM_REGULAR: '平台普通用户，在被邀请加入企业空间或集群之前没有任何资源操作权限。',
  ...
  ROLE_WORKSPACE_SELF_PROVISIONER: '企业空间普通成员，可以在企业空间下创建 DevOps 工程和项目。',
  ...
  ROLE_DEVOPS_OPERATOR: 'DevOps 工程普通成员，可以在 DevOps 工程下创建流水线凭证等。',
