...
module.exports = {
  ...
  ROLE_USERS_TIP: 'The role is bound to <strong>{count}</strong> users. Please unbind the users first.',
  ROLE_USER_TIP: 'The role is bound to <strong>{count}</strong> user. Please unbind the user first.',
  ROLE_USER_GROUPS_TIP: 'The role is bound to <strong>{count}</strong> department. Please unbind the department first.',
  ...
  WORKSPACE_ROLE_NAME_TIP: 'The role name is used as the identifier of the role.',
  ROLE_CREATE_TIP_TITLE: 'Next Step',
  ROLE_CREATE_TIP_MESSAGE: 'You need to edit role permissions to create the role.',
  ...
  CLUSTERS_MANAGEMENT_DESC: 'Create and delete clusters and manage resources in all clusters.',
  ...
  WORKSPACES_MANAGEMENT_DESC: 'Create, edit, delete and view workspaces on the platform.',
  ...
  APP_TEMPLATES_MANAGEMENT_DESC: 'Manage the platform App Store and the lifecycles (review/release/removal) of cloud native applications.',
  PLATFORM_SETTINGS_MANAGEMENT_DESC: 'Manage platform settings',
  ACCOUNT_ROLE_DESC: 'The role of an account defines the permissions of the account on the platform.',
  ACCOUNT_ROLE_CREATE_DESC: 'The role of an account defines the permissions of the account on the platform.',
  ...
  APPLICATION_WORKLOADS_VIEW_DESC: 'View applications, Services, workloads, tasks, grayscale releases and image builder tasks in a project.',
  APPLICATION_WORKLOADS_MANAGEMENT_DESC: 'Create, edit and delete applications, Services, workloads, tasks, grayscale releases and image builder tasks in a project.',
  ...
  SERVICEACCOUNT_MANAGEMENT_DESC: 'Create, edit and delete project service accounts.',
  ...
  CUSTOM_MONITORING_MANAGEMENT_DESC: 'Create and manage custom monitoring data.',
  ALERTING_POLICIES_VIEW_DESC: 'View alerting policies.',
  ALERTING_POLICIES_MANAGEMENT_DESC: 'Create, edit and delete alerting policies.',
  ...
  PROJECT_SETTINGS_DESC: 'Manage project settings, including Internet access, network policies, resource quotas, and log collection.',
  ...
  FEDERATED_PROJECTS_MANAGEMENT_DESC: 'Create, edit and delete multi-cluster projects in a workspace.',
  DEVOPS_MANAGEMENT_DESC: 'Create, edit and delete DevOps projects in a workspace.',
  ...
  WORKSPACE_GROUPS_VIEW_DESC: 'View the structure and members of an organization.',
  WORKSPACE_GROUPS_MANAGEMENT_DESC: 'Manage the structure, members, and authorization of an organization.',
  ...
  WORKSPACE_APP_REPOS_MANAGEMENT_DESC: 'Create, edit and delete app repositories.',
  ...
  WORKSPACE_SETTINGS_MANAGEMENT_DESC: 'Manage workspace settings, edit workspace information and network policies.',
  ROLE_PLATFORM_ADMIN: 'Administrator who can manage all resources on the platform.',
  ROLE_PLATFORM_REGULAR: 'Regular user who has no access to any resources before joining a workspace or cluster.',
  ROLE_CLUSTER_ADMIN: 'Administrator who has full control over all resources in the cluster.',
  ...
  ROLE_WORKSPACES_MANAGER: 'Workspace manager who can manage all workspaces on the platform.',
  ROLE_WORKSPACE_ADMIN: 'Administrator who has full control over all resources in the workspace.',
  ROLE_WORKSPACE_REGULAR: 'Regular user who cannot create projects and DevOps projects.',
  ROLE_WORKSPACE_VIEWER: 'Viewer who can view all resources in the workspace.',
  ROLE_WORKSPACE_SELF_PROVISIONER: 'Regular user who can create projects and DevOps projects.',
  ROLE_PROJECT_ADMIN: 'Administrator who has full control over all resources in the project.',
  ...
  ROLE_PROJECT_OPERATOR: 'Operater who can manage resources other than users and roles in the project.',
  ROLE_DEVOPS_ADMIN: 'Administrator who has full control over all resources in the DevOps project.',
  ROLE_DEVOPS_REGULAR: 'Regular user who can manage resources other than users and roles in the DevOps project.',
  ROLE_DEVOPS_VIEWER: 'Viewer who can view all resources in the DevOps project.',
  ROLE_DEVOPS_OPERATOR: 'Operator who can create pipeline credentials in the DevOps project.',
  NO_AUTHORIZED_USERS: 'No user is bound to this role.',
  RULE_RELATED_WITH: 'The permission cannot be deselected because {resource} depends on it.',
