...
module.exports = {
  ...
  CLUSTER_NODE_DESC: 'This module manages cluster nodes and shows the status of them. You can edit or delete nodes here.',
  CLUSTER_NODE_CREATE_DESC: 'This module manages cluster nodes and shows the status of them. You can edit or delete nodes here.',
  EDGE_NODE_DESC: 'This module manages edge nodes and shows the status of them. You can edit or delete nodes here.',
  EDGE_NODE_CREATE_DESC: 'This module manages edge nodes and shows the status of them. You can edit or delete nodes here.',
  ...
  WHAT_IS_NODE_TAINTS_A: 'Taints allow a node to repel a set of Pods. Taints and tolerations work together to ensure that Pods are not scheduled onto inappropriate nodes.',
  ...
  INSTALL_EDGENODE_DESC: 'Before running the command, you must install a container runtime such as Docker or containerd on your edge node. See the KubeEdge <a href="https://kubeedge.io/en/docs/" target="_blank">documentation</a> for more details.',
