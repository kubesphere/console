...
module.exports = {
  ...
  'The password entered twice must be the same': 'New Password and Confirm Password must be the same.',
  Time: 'Time',
  ...
  Users: 'Users',
  users: 'users',
  'You must enter the correct current password to change to a new password.': 'Enter the current password.',
  ...
  USER_NAME_DESC: 'The value can contain only lowercase letters, numbers, dots and hyphens (-) and must begin and end with a lowercase letter or number. The maximum length is 32 characters.',
  EMAIL_DESC: 'The email address can be used to log in to the system.',
  USER_SETTING_EMAIL_DESC: 'The email address can be used to log in to the system.',
  PASSWORD_DESC: 'The password can contain 6 to 64 characters and must contain at least 1 number, 1 lowercase letter, and 1 uppercase letter.',
