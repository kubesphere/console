...
module.exports = {
  ...
  SECRETS_VIEW_DESC: '查看項目裡的 Secrets',
  SECRETS_MANAGEMENT_DESC: '創建/編輯/刪除/項目裡的 Secrets',
  'ConfigMaps View': 'ConfigMaps 查看',
  'ConfigMaps Management': 'ConfigMaps 管理',
  CONFIGMAPS_VIEW_DESC: '查看項目里的 ConfigMaps',
  CONFIGMAPS_MANAGEMENT_DESC: '創建/編輯/刪除/項目里的 ConfigMaps',
