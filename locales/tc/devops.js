...
module.exports = {
  ...
  NO_RELATE_DEVOPS_DESC: '您可以創建或者聯繫項目管理員將您邀請到 DevOps 工程中開始您的工作',
  DEVOPS_PROJECT_CREDENTIALS_DESC: '憑證是包含了一些敏感數據的對象，如用戶名密碼，SSH 密鑰和 Token 等，用於在 Pipeline 運行時，為拉取代碼、push/pull 鏡像、SSH 執行腳本等過程提供認證',
  DEVOPS_PROJECT_ROLES_DESC: '成員角色定義了在目前 DevOps 工程下用戶所擁有的權限。',
  DEVOPS_PROJECT_MEM_DESC: '對工程内的成員進行管理及角色分配',
  DELETE_DEVOPS_TIP: '確定刪除 DevOps 工程 <strong>{resource}</strong> ? 刪除後將無法恢復, 工程下的資源也同時會被銷毀。',
  DEVOPS_TIP_GITOPS_Q: '如何落地 GitOps？',
  DEVOPS_TIP_GITOPS_A: '創建關聯代碼倉庫的流水線，並積極使用部署 Kubernetes 部署步驟，就可以實現 GitOps 了。',
