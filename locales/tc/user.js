...
module.exports = {
  ...
  Users: '用戶',
  users: '用戶',
  'You must enter the correct current password to change to a new password.': '您必須輸入正確的目前密碼才可更改為新的密碼',
  'Your password must meet the following requirements': '您的密碼必須符合如下要求',
  user_active: '活躍',
  USER_ACTIVE: '活躍',
  USER_AUTHLIMITEXCEEDED: '限制登入',
  USER_PENDING: '等待中',
  USER_DISABLED: '已禁用',
  USER_NAME_DESC: '最長 32 個字元，只能包含小寫字母、數字、點及隔符號("-")，且必須以小寫字母或數字開頭及結尾',
  EMAIL_DESC: '郵箱可作為登入帳號',
  USER_SETTING_EMAIL_DESC: '郵箱可作為登入帳號',
  PASSWORD_DESC: '密碼必須包含數字和大小寫字母，長度為 6 ~ 64 位',
  ROLE_DESC: '角色類型根據權限範圍分為集群和項目兩類，目前角色的授權範圍為整個集群.',
