...
module.exports = {
  ...
  IMAGE_REGISTRY_REQUIRED_DESC: '鏡像倉庫密鑰需要至少包含倉庫地址、用戶名稱和密碼資訊',
  ...
  SECRET_DESC: '密鑰 (Secret) 是一種包含少量敏感資訊的資源對象，例如密碼、token、秘鑰等，以鍵/值對形式保存並且可以在容器組中使用。',
  SECRET_CREATE_DESC: '密鑰 (Secret) 是一種包含少量敏感資訊的資源對象，例如密碼、token、秘鑰等，以鍵/值對形式保存並且可以在容器組中使用。',
