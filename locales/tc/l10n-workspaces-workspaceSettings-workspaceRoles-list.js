...
module.exports = {
  ...
  // List
  WORKSPACE_ROLE_EMPTY_DESC: '請創建一個企業空間角色。',
  ROLE_WORKSPACE_ADMIN: '企業空間的管理員，可以管理企業空間下所有的資源。',
  ROLE_WORKSPACE_REGULAR: '企業空間的普通成員，無法創建 DevOps 項目和項目。',
  ROLE_WORKSPACE_VIEWER: '企業空間的觀察者，可以查看企業空間下所有的資源資訊。',
  ROLE_WORKSPACE_SELF_PROVISIONER: '企業空間普通成員，可以在企業空間下創建 DevOps 項目和項目。',
  // List > Create
  ...
  DEVOPS_CREATE: 'DevOps 項目創建',
  DEVOPS_MANAGEMENT: 'DevOps 項目管理',
  DEVOPS_VIEW: 'DevOps 項目查看',
  DEVOPS_MANAGEMENT_DESC: '管理企業空間裡的所有 DevOps 項目，可以 創建/編輯/刪除 DevOps 項目',
  DEVOPS_CREATE_DESC: '擁有創建 DevOps 項目的權限，DevOps 項目管理員只能為創建者自己',
  DEVOPS_VIEW_DESC: '可以查看企業空間裡的所有 DevOps 項目',
  ...
  WORKSPACE_APP_TEMPLATES_MANAGEMENT_DESC: '上傳/編輯/刪除 企業空間應用模板，上架/下架應用到平台的應用商店',
  ...
  WORKSPACE_ROLES_MANAGEMENT: '企業空间角色管理',
