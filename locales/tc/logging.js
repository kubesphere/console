...
module.exports = {
  ...
  EMPTY_LOG_COLLECTIONS: '暫時沒有設置紀錄收集器，您可以添加紀錄收集器將紀錄導出到外埠的紀錄收集工具中',
  LOG_COLLECTION_TIPS: '每種類型的紀錄接收者只能添加一個，如果已存在則只能修改，不可以再添加',
  URL_SYNTAX_ERROR: 'URL 語法錯誤',
  LOG_COLLECTION_ES_URL_TIPS: '預設使用系統部署的 Elasticsearch，也可以輸入外部或者單獨部署的 Elasticsearch 地址',
  LOG_COLLECTION_ES_INDEX_TIPS: '預設按照日期分類建立索引，例：索引前綴-2020.01.01',
  'Search Logs by': '通過{field}查詢紀錄',
  'KeyWord Log Query Tip': '請輸入關鍵字查詢紀錄, 還可以通過 “Error” “Fail” “Fatal” “Exception ” “Warning” 等關鍵字查詢錯誤紀錄',
  ...
  TIME_S: '{num} s',
  CONTAINER_REAL_TIME_LOGS_UNSUPPORTED_TIPS: '容器在目前狀態下不支持實時紀錄，請稍後再試',
