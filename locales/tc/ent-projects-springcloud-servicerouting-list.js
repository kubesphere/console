...
module.exports = {
  ...
  SERVICE_ROUTING_DESC: 'As the entrance of the background architecture, the microservice gateway provides functions such as routing and forwarding, API management, and access filters, and is an important component in the microservice architecture. ',
