...
module.exports = {
  ...
  'Alerting Policies': '告警政策',
  'alerting policy': '告警政策',
  ...
  'Unavailable statefulset replicas ratio': '有狀態副本集不可用率',
  ALERT_FUNCTIONS: '函數',
  ALERT_METRICS: '指標',
  ALERT_LABELS: '標籤',
  ALERT_RATE_RANGES: '比例範圍',
  ALERT_TYPE: '{type} 告警',
  ALERTING_POLICY_CREATE_DESC: '您可以創建告警策略以即時發現資源的異常情況。',
  DELETE_TCAP: '刪除',
  // Alerting Messages
  ALERTING_RESOURCE: '告警資源',
  // Alerting Policies
  ALERTING_POLICIES: '告警政策',
