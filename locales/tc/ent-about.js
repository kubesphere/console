...
module.exports = {
  ...
  ks_QKCP_DESC_4: 'Reliability and compatibility certification from multiple professional bodies',
  QingCloud_GUIDE:
    'Visit <a href="{docUrl}" target="_blank" rel="noreferrer noopener">kubesphere.cloud</a> for more information.',
};
