...
module.exports = {
  ...
  tips_days_keep_withscm: '如果不為空，則舊分支僅保留此天數',
  tips_numbers_keep_withscm: '如果不為空，則僅保留最多此數量的舊分支',
  tips_timer_trigger:
  ...
  // SECRET_NAME_TCAP: '密鑰名稱', (Duplicated)
