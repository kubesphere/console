...
module.exports = {
  ...
  NanoSeconds: '奈秒',
  New: '新建',
  'No Available Resource': '沒有可用資源',
  No: 'No',
  'No Data': '暫無數據',
  NO_PARAMETERS: '暫無參數。',
  'No Relevant Data': 'No Relevant Data',
  NO_RELEVANT_DATA: '未發現',
  'No matching resources found.': '找不到匹配的資源。',
  'Node Selector': '節點選擇器',
  'Not Enabled': '未啟用',
  ...
  'rules desc':
    'KubeSphere 可以根據您設置的規則進行操作審計的收集，點擊查看如何定義規則。',
  EVENT_CREATE_DESC: '您可以改變搜尋條件重新查詢',
