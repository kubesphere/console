...
module.exports = {
  ...
  WORKSPACE_OVERVIEW_DESC: '企業空間為 KubeSphere 提供了安全隔離的、具有訪問權限控制的工作平台。這裡您可以看到目前企業空間内資源運行的概況。',
  WORKSPACE_DESC: '企業空間是一個組織您的項目和 DevOps 工程、管理資源訪問權限以及在團隊内部共享資源等的邏輯單元，可以作為團隊工作的獨立工作空間。',
  WORKSPACE_SEARCH_PLACEHOLDER: '請輸入企業空間名稱進行查找',
  WORKSPACE_CREATE_DESC: '企業空間是一個組織您的項目和 DevOps 工程、管理資源訪問權限以及在團隊内部共享資源等的邏輯單元，可以作為團隊工作的獨立工作空間。',
  ...
  WORKSPACE_MEMBER_DESC: '對企業空間内的成員進行管理及角色分配。項目可以邀請目前企業空間内的企業成員作為項目成員，協同工作。',
  ...
  NO_PUBLIC_CLUSTER_TIP: '暫無可用的公開集群，請在企業空間創建完畢後，向平台管理員或集群管理員申請集群的授權。',
  WORKSPACE_NO_CLUSTER_TIP: '您需要聯繫平台管理員或者集群管理員為企業空間授權集群的訪問權限',
  WORKSPACE_BASE_INFO_Q1: '如何為企業空間申請更多的集群？',
  WORKSPACE_BASE_INFO_A1: '集群由平台管理員以及集群管理員共同營運維護，如果您需要使用更多的集群請聯繫您的平台管理員，或者提交申請。',
  ...
  HOW_TO_APPLY_MORE_CLUSTER_A: '集群由平台管理員以及集群管理員共同營運維護，如果您需要使用更多的集群請聯繫您的平台管理員，或者提交申請。',
  ...
  WORKSPACE_GROUP_DESC: '組織可以以用戶組或者部門的形式授予項目以及 Devops 工程權限',
  WORKSPACE_GROUP_EMPTY_DESC: '暫時沒有可用的組織機構，請先維護組織機構後添加成員',
  WORKSPACE_GROUP_USER_EMPTY_DESC: '暫時沒有可分配的成員',
  WORKSPACE_QUOTA_MANAGE_DESC: '管理企業空間配額，企業空間下的所有項目 / DevOps 工程將共享這些配額',
