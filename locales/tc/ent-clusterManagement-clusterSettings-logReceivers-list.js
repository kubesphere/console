...
module.exports = {
  ...
  OPENSEARCH_DESC: 'You can use the OpenSearch log receiver to ingest log data into an OpenSearch database. To use this feature, you need to deploy OpenSearch in advance.',
