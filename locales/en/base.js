...
module.exports = {
  ...
  MEMORY_LIMIT: 'Resource limit: {gib} GiB ({percent})',
  ...
  NODES: 'Nodes',
  NAME_DESC:
    'The name can contain only lowercase letters, numbers, and hyphens (-) and must begin and end with a lowercase letter or number. The maximum length is 63 characters.',
  LONG_NAME_DESC:
    'The name can contain only lowercase letters, numbers, and hyphens (-), and must begin and end with a lowercase letter or number. The maximum length is 253 characters.',
  ...
  DELETE_CONFIRM_TIP:
    'Enter the {type} name <strong>{resource}</strong> to confirm that you understand the risks associated with this operation.',
