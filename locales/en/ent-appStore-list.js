...
module.exports = {
  ...
  "MODIFY_CATEGORY_HELP": "The application classification will determine the classification of the application in the app store.",
  ...
  "APP_SUSPENDED_TIP": "After app <strong>{name}</strong> is taken down, users cannot deploy this app from the middle of the store. Are you sure you want to take it down?",
  "APP_ACTIVE_TIP": "After the application <strong>{name}</strong> is launched, all relevant offline versions will become listed. Are you sure you want to list this application?",
  "APP_TEMPLATE_VERSION_DESC": "The application version needs to comply with the Semantic Version specification.",
  "APP_SUSPEND": "Removal",
  "APP_LISTING": "Listing",
  ...
  APP_DELETED_TIP: 'The application template used for the current application instance deployment does not exist .',
  ...
  Creating: 'Creating',
  creating: 'Creating',
  REPO_URL_ERR_TIP: 'Please remove the https://or http://protocol prefix from the box on the right .',
