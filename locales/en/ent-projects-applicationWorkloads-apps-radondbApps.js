...
module.exports = {
  ...
  RADONDB_APPS_DESC: 'The RadonDB database apps covers relational databases, distributed databases, time series and analytical databases, and enterprise-grade databases and services such as NoSQL.',
  ...
  DATABASE_OPERATION_WARNING: 'This operation may interrupt the database service. Please perform this operation during off-peak hours.',
  VOLUME: 'Volume',
  NODE_ROLE: 'Node Role',
  ...
  BACK_UP: 'Back Up',
  BACKUP_NAME_DESC: 'The name can contain only lowercase letters, numbers, and hyphens (-), and must start with a lowercase letter. The maximum length is 24 characters.',
  ...
  BACKUP_WARNING: 'The backup process may cause pressure on database services. Please perform this operation during off-peak hours.',
  ...
  TOPIC_REPLICA_COUNT_DESC: 'The number of replicas cannot exceed the number of nodes in the database cluster.',
  CLEANUP_POLICY: 'Cleanup Policy',
  CLEANUP_POLICY_DESC: 'Delete outdated logs or compress logs by key (Kafka Connect needs to use the compact mode).',
  COMPACT: 'Compact',
  // Details > Overview
