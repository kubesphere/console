...
module.exports = {
  ...
  WORKLOAD_PORT_NAME_DESC: 'The port name can contain only lowercase letters, numbers and hyphens (-), and must start and end with a lowercase letter or number, and cannot have consecutive hyphens. The maximum length is 15 characters.',
