...
module.exports = {
  ...
  DELETE_CLUSTER_TAGS_CONFIRM_DESC: 'Please enter the tag keys and values <strong>{resource}</strong> to confirm that you understand the risks of this operation.',
  // Cluster Tags > Edit
  EDIT_TAG: 'Edit Tag',
