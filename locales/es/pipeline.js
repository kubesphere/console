...
module.exports = {
  ...
  'Are you sure to close this pipeline Editor ?': '¿Estás seguro de cerrar este editor de pipeline?',
  ...
  'Chinese is not allowed in the pipeline configuration': 'El chino no está permitido en la configuración de la pipeline',
  ...
  critical: 'crítico',
  'Current branch name must match the input value': 'El nombre de la rama actual debe coincidir con el valor de entrada',
  'defaultValue -1 means not to discard': 'defaultValue -1 significa no descartar',
  'Delete all resources of the deployment file': 'Eliminar todos los recursos del archivo de despliegue',
  ...
  'Enable Variable Substitution in Config': 'Habilitar la sustitución de variables en la configuración',
  ...
  'Executes the code inside the block with a determined time out limit.': 'Ejecuta el código dentro del bloque con un límite de tiempo determinado.',
  ...
  info: 'informacion',
  input: 'entrada',
  'Inspection results do not affect subsequent tasks': 'Los resultados de la inspección no afectan las tareas posteriores.',
  'instance failed to match at least one schema': 'la instancia no ha modido compararse con al menos un esquema',
  'Internal nested conditions only need to satisfy one': 'Las condiciones anidadas solo necesitan cumplir una condición',
  'Internal nesting conditions must be matched': 'Las condiciones internas de anidación deben coincidir',
  ...
  'Load the sonarqube configuration provided by Jenkins into the Pipeline.': 'Cargue la configuración de sonarqube proporcionada por Jenkins en la Pipeline.',
  mail: 'correo',
  major: 'mayor',
  minor: 'menor',
  'Missing one or more required properties: \'name\'': 'Falta una o más propiedades requeridas: \'nombre\'',
  ...
  Sender: 'Remitente',
  sh: 'sh',
  'Shell commands can be executed in the container': 'Los comandos de shell se pueden ejecutar en el contenedor',
  ...
  'Sorry, you don\'t have the permission to do this.': 'Lo sentimos, no tienes permiso para hacer esto.',
  'Specify a container to add nested tasks to execute inside the container': 'Especifique un contenedor para agregar tareas anidadas para ejecutar dentro del contenedor',
  'Start the follow-up task after the inspection': 'Inicie la tarea de seguimiento después de la inspección.',
  'Started By': 'Empezado por',
  Subject: 'Tema',
  submitter: 'remitente',
  submitterParameter: 'submitterParameter',
  'Text Variable': 'Variable de texto',
  'The conditions required to implement the current phase (optional).': 'Las condiciones requeridas para implementar la fase actual (opcional).',
  'The environment variable entered before running the pipeline is match the current value.': 'La variable de entorno ingresada antes de ejecutar la pipeline coincide con el valor actual.',
  'The label on which to run the Pipeline or individual stage': 'La etiqueta en la que se ejecuta la pipeline o la fase individual',
  'This name has been used.': 'Este nombre ha sido usado.',
  'Time Used': 'Tiempo utilizado',
  Timeout: 'Se acabó el tiempo',
  TIMEOUT_VALUE: 'Se acabó el tiempo: {value}',
  timeout: 'se acabó el tiempo',
  'Timeout after no activity in logs for this block': 'Tiempo de espera agotado tras inactividad en los logs deregistro de este bloque',
  timer: 'temporizador',
  TRIGGER_REMOTE_BUILD: 'Ejecutar una build remota (por ejemplo, usando un script)',
  Unnamed: 'Sin nombre',
  'Use the following URL to remotely triggerworkbench the build': 'Utilice la siguiente URL para activar remotamente el triggerworkbench en el build',
  'User types that can trigger builds': 'Tipos de usuarios que pueden desencadenar compilaciones',
  'username or group name, multiple values ​​used, separated': 'nombre de usuario o nombre de grupo, múltiples valores utilizados, separados',
  ...
  'You can execute shell commands or windows batch commands in the build.': 'Puedes ejecutar comandos de shell o comandos por lotes de Windows en el build.',
  ...
  PIPELINE_ADVANCE_SETTINGS_DESC: 'Configure una política de comportamiento compleja para la pipeline (Opcional).',
  ...
  EDIT_CREDENTIAL_DESC: 'El siguiente formulario no mostrará la información de credenciales original. Volver a ingresarlo lo sobrescribirá.',
  pipeline_conditions: 'Condiciones',
  CODE_SMELL: 'Olor de código',
  BUG: 'Insecto',
  VULNERABILITY: 'Vulnerabilidad',
  SECURITY_HOTSPOT: 'Punto de acceso de seguridad',
  PIPELINE_CREATE_DESC: 'La ejecución de la tarea de Pipeline comenzará después de que se complete la inicialización.',
  PIPELINE_QUEUED_DESC: 'Debe esperar a que el agente se inicie y ejecute la canalización (tenga en cuenta que si el agente no se ha iniciado durante mucho tiempo, verifique la configuración del agente y los recursos del clúster).',
  waitForQualityGate_desc: 'Los estándares de control de calidad del código se derivan de la puerta de calidad de SonarQube. Si necesita personalizar los estándares, vaya a la configuración de SonarQube.',
  REVIEW_DESC: 'Cuando la pipeline se ejecute aquí, esta tarea se suspenderá y podrás optar por continuar o finalizar después de la revisión.',
  INPUT_DESC: 'Cuando la canalización se ejecuta aquí, la tarea se suspenderá, y el creador y @somebody pueden elegir continuar o finalizar la canalización.',
  LoadPrevData_Desc: 'Se detectó que esta pipeline no se editó correctamente la última vez. ¿Se cargan los últimos datos para continuar editando?',
  ...
  pipeline_owner: 'El propietario del proyecto DevOps, con la máxima autorización del proyecto, puedes realizar todas las operaciones.',
  pipeline_maintainer: 'El responsable del proyecto DevOps puedes realizar credenciales y configuración de canalización en el proyecto DevOps',
  ...
  PATTERN_PIPELINE_NAME_VALID_NAME_TIP: 'Nombre no válido (admite letras mayúsculas y minúsculas, números, "_" y "-")',
