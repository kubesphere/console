...
module.exports = {
  ...
  WORKLOAD_PORT_NAME_DESC: 'The port name can contain only lowercase letters, numbers and hyphens (-), and must begin with a lowercase letter, end with a lowercase letter or number. The maximum length is 15 characters.',
