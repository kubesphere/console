...
module.exports = {
  ...
  DISTRIBUTED_OBSERVABILITY_CENTER_DESC: 'Unified monitoring dashboard that provides metrics of all clusters managed by the platform.',
  ALERTING_CENTER: 'Alerting Center',
  SELECT_CLUSTER: 'Select Clusters',
  CUSTOM_PANEL_DESC: 'Select to aggregate monitoring indicators of multiple clusters, and customize the global monitoring page of multiple clusters. ',
  ...
  SORT_BY_CLUSTER_POD_COUNT: 'Sort by the number of container groups',
  SORT_BY_CLUSTER_POD_UTILISATION: 'Sort by pod quota usage (%)',
  SORT_BY_NODE_POD_COUNT: 'Ranked by the number of container groups',
  ...
  QOS_GUARANTEED: 'Guaranteed: For every container in a pod, the CPU/memory request and limit are equal.',
  QOS_BURSTABLE: 'Burstable: Criteria of Guaranteed is not met and at least one container has a request or limit.',
