...
module.exports = {
  ...
  REMOVE_CLUSTER_TIP_C: 'Please clear the configuration information in the cluster by refering to the KubeSphere official documentation to avoid resource conflicts when the cluster joins another multi-cluster system.',
  // Cluster Tags
  ...
  DELETE_CLUSTER_TAG_DESC: 'All clusters bound to the tag will be unbound after the tag is deleted.',
  DELETE_CLUSTER_TAG_CONFIRM_DESC: 'Please enter the tag key and value <strong>{resource}</strong> to confirm that you understand the risks of this operation.',
  DELETE_CLUSTER_TAGS_CONFIRM_DESC: 'Please enter the tag key value <strong>{resource}</strong> to confirm you understand the risk of this operation.',
  // Cluster Tags > Edit
  EDIT_TAG: 'Edit Tag',
  // Cluster Tags > Bind Clusters
  ADD_TO_CLUSTERS: 'Add to Clusters',
  ADD_TAG_TO_CLUSTERS: 'Add Tags to Clusters',
  ADD_TAG_DESC: 'The tag keys must be unique for each cluster. New tags do not overwrite existing tags.',
