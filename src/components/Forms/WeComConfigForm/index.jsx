...
export default class WeComConfigForm extends Component {
  render() {
    return (
      <Form
    ...
    if (this.props.showTip && this.props.formStatus === 'update') {
      return (
        <Alert
          ...
          type="error"
          message={t('WECOM_CONFIG_CHANGE_NEED_SAVE_TIP')}
        />
      )
    }
    return null
      ...
      <>
        <div className={styles.row}>
          <Form.Item
            ...
            rules={[
              { required: true, message: t('Please input wechat api corp id') },
            ]}
          >
            <Input name="spec.wechatApiCorpId" />
          </Form.Item>
        </div>
        <div className={styles.row}>
          <Form.Item
          ...
          >
            <Input name="spec.wechatApiAgentId" />
          </Form.Item>
          <Form.Item
            label={t('Wechat Api Secret')}
            rules={[
              { required: true, message: t('Please input wechat api secret') },
            ]}
          >
            <Input
              name="spec.wechatApiSecret.key"
              type="password"
