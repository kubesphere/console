...
export default class AffinityForm extends React.Component {
  ...
  get replicasPolicyOptions() {
      ...
      preferredDuringSchedulingIgnoredDuringExecution: [
        {
          ...
          podAffinityTerm: {
            labelSelector: {
              matchExpressions: [
                {
                  key: Object.keys(matchLabels)[0],
                  operator: 'In',
                  values: Object.values(matchLabels),
                },
              ],
            },
    ...
    return [
      ...
      {
        uid: 'soft-decentralized',
        label: t('Pod Soft Decentralized Deployment'),
        value: {
      ...
      {
        uid: 'soft-aggregation',
        label: t('Pod Soft Aggregation Deployment'),
        value: {
          podAffinity: soft,
        },
        description: t(
      ...
      {
        uid: 'hard-decentralized',
        label: t('Pod Hard Decentralized Deployment'),
        value: {
      ...
      {
        uid: 'hard-aggregation',
        label: t('Pod Hard Aggregation Deployment'),
        value: {
          podAffinity: hard,
        },
        description: t(
