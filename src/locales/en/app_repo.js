...
export default {
  ...
  APP_REPOSITORY_CREATE_DESC:
    "You can add a third-party application repository source which supports Helm-based Kubernetes apps.",
  APP_REPO_DESC:
    "You can add a third-party application repository source which supports Helm-based Kubernetes apps.",

  HOW_TO_USE_APP_REPO_Q: 'How to use an application repository?',
