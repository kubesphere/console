...
export default {
  ...
  'Min Usage': 'Uso mínimo',
  'Meter CPU Usage': 'Utilização do CPU',
  'Meter Memory Usage': 'Uso de memória',
  'Meter Volume Usage': 'Uso do volume de armazenamento',
  'Meter Net Received Usage': 'Uso líquido recebidoe',
  'Meter Net Transmitted Usage': 'Uso Transmitido Líquido',
