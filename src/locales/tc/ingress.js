...
export default {
  ...
  ROUTE_ANNOTATION_DESC:
    '可以通過給應用路由添加注解来設置應用路由的行為。詳細的可供配置的注解列表，參見 <a href="https://kubernetes.github.io/ingress-nginx/user-guide/nginx-configuration/annotations/" target="_blank">Annotations</a>。',
  ...
  NO_INTERNET_ACCESS_TIP:
    '目前項目中没有找到可用的網關地址，因此您無法設置應用路由。請聯系您的項目管理員在 <strong>高級設置</strong> 中設置外網訪問方式',
