...
export default {
  ...
  BLUE_GREEN_DEPLOYMENT_DESC:
    '藍綠發佈提供了一種零宕機的部署方式。在<strong>保留舊版本的同時部署新版本</strong>，將兩個版本同時在線，如果有問题可以快速處理。',
  CANARY_RELEASES_DESC:
    '將一部分實際流量引入一個新版本進行測試，測試新版本的性能和表現，在保證系統整體穩定運行的前提下，盡早發現新版本在實際環境上的問题。',
  AB_TESTING_DESC:
    '當產品已經相對穩定，同時又有新的業務需求或者產品形態，在保證業務的穩定運行前提下，獲取產品更新或者優化是否達到合理的預期。',
  TRAFFIC_MIRROR_DESC:
    '流量鏡像用來更為真實地測試新版本，提前發現問题，同時不對生產環境產生影響，從而，提高版本發佈的安全性可靠性。',
  ...
  JOB_OFFLINE_WARNING:
    '为了保證服務的正常運行，任務下線需要將需要保留一個可用版本並且將流量全部切换至該版本。我们需要您選擇一個需要下線的版本。系統會自動將全部流量切换至該另外的可用版本。',
