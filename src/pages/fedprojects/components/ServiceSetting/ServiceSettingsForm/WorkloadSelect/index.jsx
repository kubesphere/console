...
export default class WorkloadSelect extends React.Component {
  constructor(props) {
    ...
    this.store = this.props.isFederated
      ? new FederatedStore(new WorkloadStore(this.state.type))
      : new WorkloadStore(this.state.type)
  }
  ...
  handleOK = () => {
    const { onSelect, isFederated } = this.props
    const { selectItem } = this.state
    const labelsKey = isFederated
      ? '_originData.spec.template.spec.template.metadata.labels'
      : '_originData.spec.template.metadata.labels'

    onSelect(get(selectItem, labelsKey, {}))
  }
