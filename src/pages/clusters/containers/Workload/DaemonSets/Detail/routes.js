...
import ResourceStatus from 'projects/containers/DaemonSets/Detail/ResourceStatus'
import RevisionControl from 'projects/containers/Deployments/Detail/RevisionControl'
import Monitoring from 'projects/containers/DaemonSets/Detail/Monitoring'

const PATH = '/clusters/:cluster/namespaces/:namespace/daemonsets/:name'
