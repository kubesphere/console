...
import ClusterWrapper from '../../Clusters/ClusterWrapper';
import { formatTime, getActions } from '../../../utils';
import { InfiniteScroll } from '../../InfiniteScroll';
import type { WorkspaceFormValues, FormattedWorkspace } from '../../../types';
...
export default function WorkspaceSelectorModal({ onSelect }: WorkspaceSelectorModalProps) {
  ...
  const workspaces = formattedWorkspaces.map(formattedWorkspace => {
    const { aliasName, name, description, clusters, createTime } = formattedWorkspace;
    const fields = [
      {
