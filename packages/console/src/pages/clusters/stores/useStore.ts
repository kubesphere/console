...
import { BaseStore, PathParams } from '@ks-console/shared';
import { merge } from 'lodash';
import { useInfiniteQuery, useMutation, useQuery } from 'react-query';
import { getNextPageParam } from './base';
...
export const getMutations = <T extends ReturnType<typeof BaseStore> & { module: string }>(
  store: T,
) => {
...
export const getStoreWithQueryHooks = <T extends ReturnType<typeof BaseStore> & { module: string }>(
  store: T,
) => {
  return {
    ...store,
