...
When you are creating a bug report, please fill out [the required template](https://github.com/kubesphere/kubesphere-console/blob/master/.github/ISSUE_TEMPLATE/bug_report.md), the information it asks for helps us resolve issues faster.
...
* **Perform a [cursory search](https://github.com/kubesphere/kubesphere-console/issues)** to see if the problem has already been reported. If it has **and the issue is still open**, add a comment to the existing issue instead of opening a new one.
...
1. Follow all instructions in [the template](https://github.com/kubesphere/kubesphere-console/blob/master/.github/PULL_REQUEST_TEMPLATE.md)
